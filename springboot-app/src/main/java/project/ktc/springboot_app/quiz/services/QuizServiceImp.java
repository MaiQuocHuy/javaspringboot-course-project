...
public class QuizServiceImp implements QuizService {
  ...
  public QuizResponseDto createQuiz(CreateQuizDto createQuizDto, String instructorId) {
    log.info(
        "Creating quiz for lesson: {} by instructor: {}",
        createQuizDto.getLessonId(),
        instructorId);
    ...
    for (QuizQuestion savedQuestion : savedQuestions) {
      QuizQuestionResponseDto responseDto =
  ...
  @Override
  @Transactional
  public ResponseEntity<ApiResponse<UpdateQuizResponseDto>> updateQuiz(
      String sectionId, String lessonId, UpdateQuizDto updateQuizDto, String instructorId) {
    log.info(
        "Updating quiz for lesson: {} in section: {} by instructor: {}",
        lessonId,
        sectionId,
        instructorId);
    ...
    log.info(
        "Quiz update completed for lesson: {}. Added: {}, Removed: {}",
        lessonId,
        questionsAdded,
        questionsRemoved);
    ...
    UpdateQuizResponseDto responseDto =
        UpdateQuizResponseDto.builder()
            .questions(questionResponses)
            ...
            .updatedAt(
                savedQuestions.isEmpty()
                    ...
                    : savedQuestions.get(0).getCreatedAt())
            .build();
