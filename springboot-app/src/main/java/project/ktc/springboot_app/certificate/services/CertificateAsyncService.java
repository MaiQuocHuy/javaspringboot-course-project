 ...
 * operations. This service is
 * responsible for background tasks like PDF generation, file upload, and email
 * notifications that
...
public interface CertificateAsyncService {
	 ...
	 * saved. This
	 * includes: - Generating certificate PDF/image - Uploading to cloud storage -
	 * Updating
