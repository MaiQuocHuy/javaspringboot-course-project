 ...
 *
 * <p>
 * Features: - Profile-based CacheService selection (dev vs prod) - Consistent
 * ObjectMapper
 * configuration for cache serialization - Clean separation of concerns between
 * local and hybrid
...
public class CacheServiceConfigUnified {
	...
	/**
	 * Development Profile - Local Redis Cache Service - Uses RedisCacheServiceImp
	 * for simple local
	...
	/**
	 * Production Profile - Hybrid Cache Service - Uses HybridRedisCacheService with
	 * both Redis and
	 * Upstash REST fallback - Provides high availability and fault tolerance in
	 * production
	 */
	// @Bean("cacheService")
	// @Primary
	...
	/**
	 * Optimized ObjectMapper for Cache Serialization - Consistent DateTime
	 * formatting matching
	 * JacksonConfig - Proper timezone handling - Module registration for Java 8
	 * time types
	 */
