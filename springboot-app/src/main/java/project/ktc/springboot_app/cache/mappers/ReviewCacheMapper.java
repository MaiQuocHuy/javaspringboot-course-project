...
/**
 * Utility class for converting between review DTOs and cache DTOs. This mapper ensures clean
 * separation between service layer and cache layer, following the established codebase pattern for
 * cache operations.
 *
 * @author KTC Team
 */
public class ReviewCacheMapper {
   ...
   *
   * @param responseDto The ReviewResponseDto to convert
   ...
   *
   * @param cacheDto The ReviewCacheDto from cache
   ...
   *
   * @param responseDtos List of ReviewResponseDto to convert
   ...
   *
   * @param cacheDtos List of ReviewCacheDto from cache
  ...
  /**
   * Converts PaginatedResponse<ReviewResponseDto> to PaginatedResponse<ReviewCacheDto> for caching
   *
   * @param paginatedResponse The paginated response to convert
  ...
  /**
   * Converts PaginatedResponse<ReviewCacheDto> back to PaginatedResponse<ReviewResponseDto>
   *
   * @param cachedPaginatedResponse The cached paginated response
