...
/**
 * Mapper utility for converting Lesson entities to LessonLogDto for logging
 * purposes
 */
public class LessonLogMapper {
    ...
    public static LessonLogDto toLogDto(Lesson lesson) {
        ...
        LessonLogDto.LessonLogDtoBuilder builder = LessonLogDto.builder()
                .id(lesson.getId())
        ...
        if (lesson.getSection() != null) {
            builder.sectionId(lesson.getSection().getId())
            ...
            if (lesson.getSection().getCourse() != null) {
                builder.courseId(lesson.getSection().getCourse().getId())
        ...
        if (lesson.getContent() != null) {
            ...
            LessonLogDto.VideoContentLogDto videoLogDto = LessonLogDto.VideoContentLogDto.builder()
                    .id(videoContent.getId())
                    .url(videoContent.getUrl())
                    .duration(videoContent.getDuration())
                    .uploadedBy(videoContent.getUploadedBy() != null ? videoContent.getUploadedBy().getId() : null)
