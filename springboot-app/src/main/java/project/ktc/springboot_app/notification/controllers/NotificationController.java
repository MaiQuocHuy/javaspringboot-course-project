...
public class NotificationController {
    ...
    public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> createNotificationInternal(
        ...
        log.info("Received internal request to create notification for user: {}", createNotificationDto.getUser_id());
    ...
    public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAllNotifications() {
        ...
        try {
            ...
            notificationHelper.createPaymentSuccessNotification(
                    "user-100", "payment-100", "Complete Web Development", "/courses/complete-web-dev").get();

            notificationHelper.createEnrollmentNotification(
                    "user-101", "enrollment-100", "Full Stack Development", "/courses/full-stack-dev").get();

            notificationHelper.createCertificateNotification(
                    "user-102", "certificate-100", "DevOps Essentials", "/certificates/devops-essentials").get();

            notificationHelper.createCourseApprovalNotification(
                    "instructor-100", "course-100", "Cloud Computing", "/courses/cloud-computing", true).get();

            notificationHelper.createRefundNotification(
                    "user-103", "refund-100", "Data Science", "/refunds/refund-100", "approved").get();

            // Test admin notifications
            notificationHelper.createAdminStudentPaymentNotification(
                    "payment-101", "Student Test", "Test Course", "2,000,000 VND");
