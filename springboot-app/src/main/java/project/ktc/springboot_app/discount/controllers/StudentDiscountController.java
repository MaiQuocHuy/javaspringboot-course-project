...
/**
 * REST Controller for student discount operations Allows students to view their
 * discount usage and
 * affiliate payouts
 */
@RestController
...
public class StudentDiscountController {
	...
	/**
	 * Get discount usages where the current student is the referrer (People using
	 * the student's
	 * discount code)
	 *
	 * @param pageable
