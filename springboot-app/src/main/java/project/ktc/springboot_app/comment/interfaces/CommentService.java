...
public interface CommentService {
     ...
     */
    ResponseEntity<ApiResponse<CommentResponse>> createComment(String lessonId, CreateCommentRequest request,
            String userId);
     ...
     */
    ResponseEntity<ApiResponse<PaginatedResponse<CommentResponse>>> getCommentsByLesson(String lessonId,
            Pageable pageable);
     ...
     */
    ResponseEntity<ApiResponse<CommentResponse>> updateComment(String commentId, UpdateCommentRequest request,
            String userId);
