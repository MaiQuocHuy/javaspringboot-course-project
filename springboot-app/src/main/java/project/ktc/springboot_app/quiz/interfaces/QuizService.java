...
public interface QuizService {
    ...
    /**
     * Updates (replaces) quiz questions for a lesson
     * This is a full replacement - questions not included will be deleted
     * 
     * @param sectionId     Section ID containing the lesson
     * @param lessonId      Lesson ID to update quiz for
     * @param updateQuizDto Update quiz data
     * @param instructorId  ID of the instructor updating the quiz
     * @return Updated quiz response with statistics
     */
    ResponseEntity<ApiResponse<UpdateQuizResponseDto>> updateQuiz(String sectionId, String lessonId,
