...
public class AsyncSendMessageRequest {
  ...
  @NotBlank
  @Pattern(
      regexp = "^(TEXT|FILE|VIDEO|AUDIO)$",
      message = "Type must be 'TEXT', 'FILE', 'VIDEO', or 'AUDIO'")
  @Schema(
      description = "Type of message",
      example = "TEXT",
      allowableValues = {"TEXT", "FILE", "VIDEO", "AUDIO"},
      requiredMode = Schema.RequiredMode.REQUIRED)
  private String type;
  ...
  @Schema(
      ...
      example =
          "https://res.cloudinary.com/example/image/upload/v1234567890/video_thumbnails/thumb.jpg")
