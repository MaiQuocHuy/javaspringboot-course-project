...
/**
 * Base interface for cache operations. Provides common caching functionality
 * that can be
 * implemented by specific cache services (Redis, Hazelcast, etc.).
 *
 * @author KTC Team
 */
public interface CacheService {
	 ...
	 *            cache key
	 * @param elementClass
	 *            expected element type in the list
	 * @param <T>
	 *            element type
