...
public interface PaymentRepository extends JpaRepository<Payment, String> {
	...
	/**
	 * Find all payments for a specific user with pagination support Orders by
	 * creation date
	...
	/**
	 * Find all payments for a specific user without pagination Orders by creation
	 * date descending
	 * (most recent first)
	 */
	@Query("SELECT p FROM Payment p "
	...
	/**
	 * Find a specific payment by ID and user ID Ensures that the payment belongs to
	 * the specified
	 * user
	 */
	@Query("SELECT p FROM Payment p "
	...
	/**
	 * Find a specific payment by course ID and user ID Returns the most recent
	 * payment for the
	 * course-user combination Uses LIMIT 1 to handle cases with multiple payment
	 * attempts
	 */
	...
	/**
	 * Find the most recent COMPLETED payment by course ID and user ID This is used
	 * specifically to
