...
public interface PermissionService {
	 ...
	 *            the user
	 * @param permissionKey
	 *            the permission key (e.g., "course:create")
	...
	/**
	 * Get all permissions assigned to a specific role (for admin purposes) This
	...
	/**
	 * Update permissions for a specific role (for admin purposes) This allows
	 * enabling/disabling
	 ...
	 * role This builds a
	 * tree structure showing which resources the role has permissions for (both
	 ...
	 * This shows all
	 * permissions in the system and indicates which ones are constrained for the
	 * given role
	 *
	 * @param roleId
	 *            the role ID to check constraints against
	 ...
	 * assignability information This
