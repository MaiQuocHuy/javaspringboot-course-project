...
public class StripeCheckoutService {
  ...
  public Session createCheckoutSession(String userId, Course course) throws StripeException {
    ...
    PriceCalculationResponse priceCalc =
                        ...
                        SessionCreateParams.LineItem.PriceData.builder()
                            ...
                            .setProductData(
                                SessionCreateParams.LineItem.PriceData.ProductData.builder()
                                    ...
                                    .setDescription(
                                        buildProductDescription(course, priceCalculation))
                                    .addImage(
  ...
  /**
   * Converts price to Stripe amount (smallest currency unit) For USD, this means converting dollars
   * to cents
   */
  ...
  private String buildProductDescription(Course course, PriceCalculationResponse priceCalculation) {
    StringBuilder description =
        new StringBuilder(course.getDescription() != null ? course.getDescription() : "");
