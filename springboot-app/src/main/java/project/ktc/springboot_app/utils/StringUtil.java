...
public class StringUtil {
	...
	/**
	 * Generates a normalized slug from a given name This ensures consistent slug
	 * format across the
	 * application
	 *
	 * @param name
	...
	/**
	 * Normalizes a slug for comparison purposes This method should be used when
	 * checking for
	 * duplicate slugs
	 *
	 * @param slug
	 *            the slug to normalize
