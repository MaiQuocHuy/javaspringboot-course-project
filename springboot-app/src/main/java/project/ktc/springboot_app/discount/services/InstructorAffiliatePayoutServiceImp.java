...
public class InstructorAffiliatePayoutServiceImp implements InstructorAffiliatePayoutService {
  ...
  @Override
  public ResponseEntity<ApiResponse<PaginatedResponse<InstructorAffiliatePayoutResponseDto>>>
    ...
    try {
      Page<AffiliatePayout> affiliatePayoutPage =
          instructorAffiliatePayoutRepository.findByCourseInstructorId(instructorId, pageable);

      Page<InstructorAffiliatePayoutResponseDto> responsePage =
          affiliatePayoutPage.map(InstructorAffiliatePayoutResponseDto::fromEntity);

      PaginatedResponse<InstructorAffiliatePayoutResponseDto> paginatedResponse =
          PaginatedResponse.<InstructorAffiliatePayoutResponseDto>builder()
  ...
  public ResponseEntity<
      ...
      getAffiliatePayoutById(String affiliatePayoutId) {
    ...
    try {
      AffiliatePayout affiliatePayout =
          instructorAffiliatePayoutRepository.findByIdAndCourseInstructorId(
      ...
      InstructorAffiliatePayoutResponseDto responseDto =
          InstructorAffiliatePayoutResponseDto.fromEntity(affiliatePayout);
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<InstructorAffiliatePayoutResponseDto>>>
    ...
    try {
      ...
      Page<AffiliatePayout> affiliatePayoutPage =
          instructorAffiliatePayoutRepository.findByCourseInstructorIdWithFilter(
