...
public class SendMessageRequest {
  ...
  @Schema(
      description =
          "Message content. For TEXT messages this is the text content. For other types, this can be URL or base64 data",
      example = "Hello everyone! How are you doing with the course?",
      requiredMode = Schema.RequiredMode.REQUIRED)
  private String
      content; // For TEXT; for others expect URL or base64 placeholder (further refinement

  // later)

  @Schema(
      description = "File name (required for FILE, AUDIO, VIDEO types)",
