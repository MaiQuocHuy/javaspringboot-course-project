...
public class NotificationController {
        ...
        @PostMapping
        @Operation(summary = "Create a new notification", description = "Creates a new notification for a given user. Only users with the ADMIN role are authorized to call this API.")
        @ApiResponses(value = {
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> createNotification(
                        @Valid @RequestBody CreateNotificationDto createNotificationDto) {

                log.info("Received request to create notification for user: {}", createNotificationDto.getUser_id());

                try {
                        NotificationResponseDto notification = notificationService
                                        .createNotification(createNotificationDto).get(); // Convert
                                                                                          // async
                                                                                          // to
                                                                                          // sync
                        ...
                        if (e.getCause() != null) {
                                ...
                                if (cause instanceof project.ktc.springboot_app.common.exception.ResourceNotFoundException) {
        ...
        /**
         * Create notification synchronously for internal system use
         * This endpoint can be used by other services within the system
         */
        @PostMapping("/internal")
        @Operation(summary = "Create notification internally", description = "Creates a notification synchronously for internal system use")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> createNotificationInternal(
                        @Valid @RequestBody CreateNotificationDto createNotificationDto) {

                log.info("Received internal request to create notification for user: {}",
                                createNotificationDto.getUser_id());

                try {
                        NotificationResponseDto notification = notificationService
                                        .createNotificationSync(createNotificationDto);
         ...
         */
        @PostMapping("/test")
        @Operation(summary = "Create test notification", description = "Creates a test notification for development purposes")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> createTestNotification() {
                ...
                try {
                        CreateNotificationDto testNotification = CreateNotificationDto.builder()
                                        ...
                                        .message("Test notification: Thanh toán thành công cho khóa học 'Advanced React Development'")
                        ...
                        NotificationResponseDto notification = notificationService
                                        .createNotificationSync(testNotification);
         ...
         */
        @GetMapping("/test")
        @Operation(summary = "Simple test endpoint", description = "GET endpoint for quick testing without authentication")
        ...
        @Operation(summary = "Test payment success notification", description = "Creates a test payment success notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testPaymentSuccess() {
                log.info("Testing payment success notification");

                try {
                        NotificationResponseDto notification = notificationHelper.createPaymentSuccessNotification(
                                        "user-001", // userId
                        ...
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> response = project.ktc.springboot_app.common.dto.ApiResponse
                                        .created(
                                                        notification,
                                                        "Payment success notification created successfully");
                        return ResponseEntity.status(201).body(response);
                } catch (Exception e) {
        ...
        @Operation(summary = "Test enrollment notification", description = "Creates a test enrollment notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testEnrollment() {
                log.info("Testing enrollment notification");

                try {
                        NotificationResponseDto notification = notificationHelper.createEnrollmentNotification(
                                        "user-002", // userId
                        ...
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> response = project.ktc.springboot_app.common.dto.ApiResponse
                                        .created(
                                                        notification,
                                                        "Enrollment notification created successfully");
                        return ResponseEntity.status(201).body(response);
                } catch (Exception e) {
        ...
        @Operation(summary = "Test certificate notification", description = "Creates a test certificate notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testCertificate() {
                log.info("Testing certificate notification");

                try {
                        NotificationResponseDto notification = notificationHelper.createCertificateNotification(
                                        "user-003", // userId
                        ...
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> response = project.ktc.springboot_app.common.dto.ApiResponse
                                        .created(
                                                        notification,
                                                        "Certificate notification created successfully");
                        return ResponseEntity.status(201).body(response);
                } catch (Exception e) {
        ...
        @Operation(summary = "Test refund notification", description = "Creates a test refund notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testRefund() {
                log.info("Testing refund notification");

                try {
                        NotificationResponseDto notification = notificationHelper.createRefundNotification(
                                        "user-004", // userId
                                        "refund-001", // refundId
                        ...
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> response = project.ktc.springboot_app.common.dto.ApiResponse
                                        .created(
                                                        notification,
                                                        "Refund notification created successfully");
                        return ResponseEntity.status(201).body(response);
                } catch (Exception e) {
        ...
        @Operation(summary = "Test admin student payment notification", description = "Creates a test admin student payment notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAdminStudentPayment() {
                ...
                try {
                        ...
                        return ResponseEntity.status(500).body(project.ktc.springboot_app.common.dto.ApiResponse.error(
        ...
        @Operation(summary = "Test admin payment status change notification", description = "Creates a test admin payment status change notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAdminPaymentStatusChange() {
        ...
        @Operation(summary = "Test admin course approval needed notification", description = "Creates a test admin course approval needed notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAdminCourseApprovalNeeded() {
        ...
        @Operation(summary = "Test admin instructor application notification", description = "Creates a test admin instructor application notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAdminInstructorApplication() {
        ...
        @Operation(summary = "Test all notifications", description = "Creates all types of test notifications")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAllNotifications() {
        ...
        @Operation(summary = "Test instructor course approved notification", description = "Creates a test instructor course approved notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testInstructorCourseApproved() {
                log.info("Testing instructor course approved notification");

                try {
                        NotificationResponseDto notification = notificationHelper
                        ...
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> response = project.ktc.springboot_app.common.dto.ApiResponse
                                        .created(
                                                        notification,
                                                        "Instructor course approved notification created successfully");
                        return ResponseEntity.status(201).body(response);
                } catch (Exception e) {
        ...
        @Operation(summary = "Test instructor course rejected notification", description = "Creates a test instructor course rejected notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testInstructorCourseRejected() {
                ...
                try {
                        ...
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> response = project.ktc.springboot_app.common.dto.ApiResponse
                                        .created(
                                                        notification,
                                                        "Instructor course rejected notification created successfully");
                        return ResponseEntity.status(201).body(response);
                } catch (Exception e) {
        ...
        @Operation(summary = "Test instructor new student notification", description = "Creates a test instructor new student enrollment notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testInstructorNewStudent() {
                ...
                try {
                        ...
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> response = project.ktc.springboot_app.common.dto.ApiResponse
                                        .created(
                                                        notification,
                                                        "Instructor new student notification created successfully");
                        return ResponseEntity.status(201).body(response);
                } catch (Exception e) {
        ...
        @Operation(summary = "Test all instructor notifications", description = "Creates all types of instructor test notifications")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAllInstructorNotifications() {
                log.info("Testing all instructor notification types");

                try {
                        // Test instructor notifications
                        notificationHelper.createInstructorCourseApprovedNotification(
                                        "instructor-100", "course-100", "Full Stack Development",
                                        "/instructor/courses/course-100").get();

                        notificationHelper.createInstructorCourseRejectedNotification(
                                        "instructor-101", "course-101", "Mobile App Development",
                                        "/instructor/courses/course-101",
                                        "Cần bổ sung thêm tài liệu và video thực hành").get();
        ...
        @Operation(summary = "Test student instructor application approved notification", description = "Creates a test student instructor application approved notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testStudentInstructorApproved() {
                ...
                try {
                        ...
                        log.error("Error creating student instructor application approved notification: {}",
                                        e.getMessage(), e);
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> errorResponse = project.ktc.springboot_app.common.dto.ApiResponse
                                        .error(500, "Error: " + e.getMessage());
                        return ResponseEntity.status(500).body(errorResponse);
        ...
        @Operation(summary = "Test student instructor application rejected notification", description = "Creates a test student instructor application rejected notification")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> testStudentInstructorRejected() {
                ...
                try {
                        ...
                        log.error("Error creating student instructor application rejected notification: {}",
                                        e.getMessage(), e);
                        project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto> errorResponse = project.ktc.springboot_app.common.dto.ApiResponse
                                        .error(500, "Error: " + e.getMessage());
                        return ResponseEntity.status(500).body(errorResponse);
        ...
        @Operation(summary = "Test all student notifications", description = "Creates all types of student test notifications")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAllStudentNotifications() {
                log.info("Testing all student notification types");

                try {
                        // Test student notifications
                        notificationHelper.createStudentInstructorApplicationApprovedNotification(
                                        "student-100", "application-100").get();

                        notificationHelper.createStudentInstructorApplicationRejectedNotification(
                                        "student-101", "application-101",
                                        "Hồ sơ chưa đạt yêu cầu, vui lòng cập nhật CV và portfolio").get();
        ...
        @Operation(summary = "Test admin notification filtering with filter-type-001", description = "Tests admin notification filtering to only users with ALL access permissions")
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<String>> testAdminNotificationFiltering() {
