...
/**
 * Repository interface for Permission Role Assign Rule entity Handles database
 * operations for
...
public interface PermissionRoleAssignRuleRepository
	...
	/**
	 * Find all assignable permission IDs for a specific role Returns only active
	 * rules where
	...
	/**
	 * Find all assignable permission keys for a specific role Returns only active
	 * rules where
	 * permissions can be assigned to the role
	 *
	 * @param roleId
