...
public interface CertificateService {
  ...
  /**
   * Create a new certificate for a user who completed a course Only ADMIN users can create
   * certificates
   *
  ...
  /**
   * Get all certificates with pagination and optional search Only ADMIN users can access this
   * endpoint
   *
  ...
  /**
   * Get certificate details by ID ADMIN users can access any certificate STUDENT/INSTRUCTOR users
  ...
  /**
   * Get certificate by certificate code Public endpoint - no authentication required
   *
  ...
  /**
   * Get certificates for a specific user ADMIN users can access any user's certificates
  ...
  /**
   * Get certificates for a specific course Only ADMIN and course INSTRUCTOR can access this
   * endpoint
   *
  ...
  /**
   * Get current user's certificates Returns certificates for the authenticated user
   *
   * @param pageable Pagination parameters
  ...
  /**
   * Download certificate PDF Available to certificate owner, course instructor, and ADMIN users
   *
   * @param certificateId Certificate ID
  ...
  /**
   * Check if current user has access to the certificate Used for security authorization
   *
   * @param certificateId Certificate ID
  ...
  /**
   * Create a new certificate asynchronously for a user who completed a course Only ADMIN users can
   * create certificates The certificate creation process runs in background and includes: -
   * Validation of user and course - PDF generation - Cloud storage upload - Email notification
   *
   * @param createCertificateDto Certificate creation data
   * @return Immediate response with certificate basic info (PDF will be generated asynchronously)
   */
