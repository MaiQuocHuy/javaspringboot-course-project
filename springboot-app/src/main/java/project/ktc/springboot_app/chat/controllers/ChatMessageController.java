...
public class ChatMessageController {
  ...
  @Operation(
      summary = "Send a chat message asynchronously",
      description =
          "Send a message to a course chat with immediate acknowledgment and async processing. Returns PENDING status immediately, then sends confirmation via WebSocket.",
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = AsyncMessageAcknowledgment.class))),
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<AsyncMessageAcknowledgment>>
      sendMessage(
          @Parameter(
              ...
              @PathVariable
              String courseId,
          @Parameter(description = "Async message content with tempId", required = true)
              @Valid
              @RequestBody
  ...
  @Operation(
      summary = "Send a chat message synchronously",
      description =
          "Send a message to a course chat synchronously. User must be enrolled in the course or be the instructor.",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses(
      value = {
        @ApiResponse(
        ...
        @ApiResponse(
            responseCode = "403",
            description = "User not enrolled in course or insufficient permissions"),
        @ApiResponse(responseCode = "404", description = "Course not found"),
        @ApiResponse(responseCode = "500", description = "Internal server error")
      })
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<ChatMessageResponse>>
      sendMessageSync(
          @Parameter(
                  description = "Course ID",
                  required = true,
              ...
              @PathVariable
              String courseId,
          @Parameter(description = "Message content", required = true) @Valid @RequestBody
  ...
  @Operation(
      ...
      description =
          "Retrieve paginated list of messages for a course. User must be enrolled in the course or be the instructor. Supports both regular pagination and infinite scroll with keyset pagination.",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<ChatMessagesListResponse>>
      getMessages(
          @Parameter(
                  description = "Course ID",
                  required = true,
          ...
          @Parameter(
                  description =
                      "Page number (0-based), ignored if beforeMessageId or afterMessageId is provided",
                  example = "0")
          ...
          @Parameter(description = "Number of messages per page", example = "50")
              ...
              Integer size,
          @Parameter(
                  description = "Fetch messages created before this message ID (keyset pagination)",
                  example = "123")
              @RequestParam(required = false)
              String beforeMessageId,
          @Parameter(
                  description = "Fetch messages created after this message ID (keyset pagination)",
                  example = "456")
              @RequestParam(required = false)
    ...
    return chatMessageService.getMessages(
        courseId, email, page, size, beforeMessageId, afterMessageId);
  }
  ...
  @Operation(
      ...
      description =
          "Delete a specific chat message from a course. Only the message owner or instructor/admin can delete it.",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "403",
            description = "User is not the message owner or lacks permission"),
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<Void>> deleteMessage(
      ...
      @Parameter(
              ...
              required = true,
              example = "7200a420-2ff3-4f18-9933-1b86d05f1a79")
          @PathVariable
          String messageId,
      Authentication authentication) {
    String email = authentication.getName();
  ...
  @Operation(
      ...
      description =
          "Update the content of a specific chat message from a course. Only the message owner can update it and only TEXT messages can be updated.",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses(
      value = {
        @ApiResponse(
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Invalid request data or message type is not TEXT"),
        @ApiResponse(responseCode = "401", description = "User not authenticated"),
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<ChatMessageResponse>>
      updateMessage(
          ...
          @Parameter(
              ...
              @PathVariable
              String messageId,
          @Parameter(description = "Updated message content", required = true) @Valid @RequestBody
