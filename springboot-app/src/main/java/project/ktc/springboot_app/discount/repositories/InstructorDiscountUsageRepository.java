...
/**
 * Repository for instructor discount usage operations Handles queries for discount usage from
...
public interface InstructorDiscountUsageRepository extends JpaRepository<DiscountUsage, String> {
  ...
  /**
   * Find all discount usages for courses owned by the instructor with search and filtering Search
   * by discount usage ID, discount code, user name, or course title Filter by discount type and
   * date range
   */
  @Query(
      """
