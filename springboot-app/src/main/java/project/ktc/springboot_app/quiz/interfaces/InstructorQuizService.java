...
public interface InstructorQuizService {
    ...
    ResponseEntity<ApiResponse<PaginatedResponse<QuizScoreResponseDto>>> getStudentQuizScores(String studentId,
            Pageable pageable);

    ResponseEntity<ApiResponse<QuizScoreDetailResponseDto>> getStudentQuizScoreDetail(String studentId,
            String quizResultId);
}
