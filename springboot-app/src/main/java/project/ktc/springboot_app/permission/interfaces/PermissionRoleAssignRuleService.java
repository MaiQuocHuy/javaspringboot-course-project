...
/**
 * Service interface for managing Permission Role Assignment Rules
...
public interface PermissionRoleAssignRuleService {
     ...
     */
    PermissionRoleAssignRule createAssignmentRule(String roleId, String permissionId, boolean isActive);
    ...
    /**
     * Validate permission assignment before creating role-permission relationship
     * Throws exception if assignment is not allowed
     * 
     * @param roleId       the role ID
     * @param permissionId the permission ID
