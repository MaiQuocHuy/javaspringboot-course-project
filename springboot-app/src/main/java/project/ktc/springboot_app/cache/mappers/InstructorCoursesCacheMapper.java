...
/** Mapper for converting between Course entities and instructor-specific cache DTOs */
public class InstructorCoursesCacheMapper {

  /**
   * Converts Course entity to InstructorCourseBaseCacheDto for Redis storage Note: statusReview and
   * reason should be set separately via updateCacheWithReviewInfo()
   */
  public static InstructorCourseBaseCacheDto toBaseCacheDto(Course course) {
    ...
    InstructorCourseBaseCacheDto.InstructorCourseBaseCacheDtoBuilder builder =
    ...
    if (course.getCategories() != null) {
      List<InstructorCourseBaseCacheDto.CategoryCacheDto> categoryDtos =
  ...
  /**
   * Converts Course entity to InstructorCourseBaseCacheDto for Redis storage with review status
   * information
   */
  public static InstructorCourseBaseCacheDto toBaseCacheDtoWithReviewInfo(
      Course course, String statusReview, String reason) {
  ...
  public static InstructorCourseDynamicCacheDto toDynamicCacheDto(
      CourseDashboardResponseDto courseDto) {
    if (courseDto == null) {
      return null;
    }
  ...
  public static CourseDashboardResponseDto mergeCacheData(
      InstructorCourseBaseCacheDto baseInfo, InstructorCourseDynamicCacheDto dynamicInfo) {
    if (baseInfo == null) {
      return null;
    }
    ...
    return CourseDashboardResponseDto.dashboardBuilder()
        ...
        .lastContentUpdate(
            dynamicInfo != null ? dynamicInfo.getLastContentUpdate() : baseInfo.getUpdatedAt())
  ...
  private static InstructorCourseBaseCacheDto.CategoryCacheDto toCategoryCacheDto(
      Category category) {
    if (category == null) {
      return null;
    }
    ...
    return InstructorCourseBaseCacheDto.CategoryCacheDto.builder()
        ...
        .slug(
            category.getName().toLowerCase().replaceAll(" ", "-")) // Generate slug if not available
        .build();
  }
  ...
  /**
   * Determines course status from cache data based on isPublished field This logic mirrors the
   * determineStatus method in InstructorCourseServiceImp but includes null checks since cache DTOs
   * may have null values after deserialization
   */
  ...
  /** Converts list of CourseDashboardResponseDto to list of InstructorCourseDynamicCacheDto */
