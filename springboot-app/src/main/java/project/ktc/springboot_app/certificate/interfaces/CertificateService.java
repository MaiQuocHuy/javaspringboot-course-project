...
public interface CertificateService {
         ...
         * ADMIN users can access any certificate
         ...
         * @return Certificate details
         */
        ResponseEntity<ApiResponse<CertificateResponseDto>> getCertificateByCertificateCode(String certificateCode);

        /**
         * Get certificates for a specific user
         * ADMIN users can access any user's certificates
         * STUDENT/INSTRUCTOR users can only access their own certificates
         * 
         ...
         * Only ADMIN and course INSTRUCTOR can access this endpoint
         * 
         ...
         * Returns certificates for the authenticated user
         * 
         * @param pageable Pagination parameters
         * @return Paginated list of current user's certificates
         */
        ResponseEntity<ApiResponse<PaginatedResponse<CertificateListDto>>> getMyCertificates(Pageable pageable);

        /**
         * Download certificate PDF
         * Available to certificate owner, course instructor, and ADMIN users
         * 
         * @param certificateId Certificate ID
         ...
         * Only ADMIN users can regenerate PDFs
         * 
         * @param certificateId Certificate ID
         * @return Updated certificate details
         */
        ResponseEntity<ApiResponse<CertificateResponseDto>> regenerateCertificatePdf(String certificateId);
