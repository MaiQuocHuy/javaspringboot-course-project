...
/**
 * Central repository for all cache-related constants. This class ensures consistency across the
 * application for cache prefixes, TTL values, and other cache configuration constants.
 *
 * @author KTC Team
 */
public final class CacheConstants {
  ...
  /**
   * TTL for shared course data cache (30 minutes) Used for courses + categories + enrollmentCounts
  ...
  /**
   * TTL for course structure cache (30 minutes) Course structure includes sections, lessons,
  ...
  /**
   * TTL for public user profile detail cache (3 hours - for GET /api/users/profile/{id}) Public
  ...
  /**
   * TTL for instructor statistics cache (15 minutes) Statistics data is aggregated from multiple
   * sources and changes less frequently
   */
  public static final Duration INSTRUCTOR_STATISTICS_TTL = Duration.ofMinutes(15);

  /**
   * TTL for instructor courses base info cache (7 minutes) Base course info changes less frequently
   */
  public static final Duration INSTRUCTOR_COURSES_BASE_TTL = Duration.ofMinutes(7);

  /**
   * TTL for instructor courses dynamic info cache (45 seconds) Dynamic info like enrollments and
   ...
   */
  public static final String COURSES_LIST_PATTERN =
      COURSES_CACHE_PREFIX + ":page:%d:size:%d:filters:%s";
   ...
   */
  public static final String COURSES_SHARED_PATTERN =
      COURSES_CACHE_PREFIX + ":shared:page:%d:size:%d:filters:%s";

  /**
   * Pattern for user-specific enrollment status cache Format:
   * enrollments:user:user-id:courses:course-id1,course-id2,...
   */
  public static final String USER_ENROLLMENT_STATUS_PATTERN =
      ENROLLMENTS_CACHE_PREFIX + ":user:%s:courses:%s";
   ...
   */
  public static final String INSTRUCTOR_COURSES_PATTERN =
      INSTRUCTOR_COURSES_CACHE_PREFIX + ":instructor:%s:page:%d:size:%d:filters:%s";
  ...
  public static final String COURSE_REVIEW_STATS_PATTERN =
      REVIEWS_CACHE_PREFIX + ":course:%s:stats";

  /**
   * Pattern for instructor courses statistics Format:
   * instructor_statistics:instructor:instructor-id:courses
   */
  public static final String INSTRUCTOR_COURSES_STATISTICS_PATTERN =
      INSTRUCTOR_STATISTICS_CACHE_PREFIX + ":instructor:%s:courses";

  /**
   * Pattern for instructor earnings statistics Format:
   * instructor_statistics:instructor:instructor-id:earnings
   */
  public static final String INSTRUCTOR_EARNINGS_STATISTICS_PATTERN =
      INSTRUCTOR_STATISTICS_CACHE_PREFIX + ":instructor:%s:earnings";

  /**
   * Pattern for instructor students statistics Format:
   * instructor_statistics:instructor:instructor-id:students
   */
  public static final String INSTRUCTOR_STUDENTS_STATISTICS_PATTERN =
      INSTRUCTOR_STATISTICS_CACHE_PREFIX + ":instructor:%s:students";

  /**
   * Pattern for instructor reviews statistics Format:
   * instructor_statistics:instructor:instructor-id:reviews
   */
  public static final String INSTRUCTOR_REVIEWS_STATISTICS_PATTERN =
      INSTRUCTOR_STATISTICS_CACHE_PREFIX + ":instructor:%s:reviews";

  /** Pattern for user enrollment cache Format: enrollments:user:user-id:page:0:size:10 */
  public static final String USER_ENROLLMENTS_PATTERN =
      ENROLLMENTS_CACHE_PREFIX + ":user:%s:page:%d:size:%d";

  /**
   * Pattern for course reviews cache Format:
   * reviews:course:course-id:page:0:size:10:sort:sort-params
   */
  public static final String COURSE_REVIEWS_PATTERN =
      REVIEWS_CACHE_PREFIX + ":course:%s:page:%d:size:%d:sort:%s";

  /**
   * Pattern for instructor statistics cache Format: instructor_statistics:instructor:instructor-id
   */
  public static final String INSTRUCTOR_STATISTICS_PATTERN =
      INSTRUCTOR_STATISTICS_CACHE_PREFIX + ":instructor:%s";
   ...
   */
  public static final String INSTRUCTOR_COURSES_BASE_PATTERN =
      INSTRUCTOR_COURSES_CACHE_PREFIX + ":instructor:%s:base:page:%d:size:%d:filters:%s";

  /** Pattern for course dynamic info cache Format: instructor_courses:course:course-id:dynamic */
  public static final String COURSE_DYNAMIC_PATTERN =
      INSTRUCTOR_COURSES_CACHE_PREFIX + ":course:%s:dynamic";
  ...
  public static final String USER_ENROLLMENTS_INVALIDATION_PATTERN =
      ENROLLMENTS_CACHE_PREFIX + ":user:%s:*";

  /** Pattern to match course-specific reviews for invalidation */
  public static final String COURSE_REVIEWS_INVALIDATION_PATTERN =
      REVIEWS_CACHE_PREFIX + ":course:%s:*";

  /** Pattern to match instructor statistics for invalidation */
  public static final String INSTRUCTOR_STATISTICS_INVALIDATION_PATTERN =
      INSTRUCTOR_STATISTICS_CACHE_PREFIX + ":instructor:%s";

  /** Pattern to match instructor courses for invalidation */
  public static final String INSTRUCTOR_COURSES_INVALIDATION_PATTERN =
      INSTRUCTOR_COURSES_CACHE_PREFIX + ":instructor:%s:*";
