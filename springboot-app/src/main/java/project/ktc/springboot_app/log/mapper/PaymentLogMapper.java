...
/** Mapper utility for converting Payment entity to PaymentLogDto for audit logging */
public class PaymentLogMapper {
  ...
  public static PaymentLogDto toLogDto(Payment payment) {
    ...
    PaymentLogDto.PaymentLogDtoBuilder builder =
    ...
    if (payment.getUser() != null) {
      builder
          ...
          .user(
              PaymentLogDto.UserLogDto.builder()
    ...
    if (payment.getCourse() != null) {
      PaymentLogDto.CourseLogDto.CourseLogDtoBuilder courseBuilder =
          PaymentLogDto.CourseLogDto.builder()
      ...
      if (payment.getCourse().getInstructor() != null) {
        courseBuilder
            .instructorId(payment.getCourse().getInstructor().getId())
            .instructorName(payment.getCourse().getInstructor().getName());
      }

      builder.courseId(payment.getCourse().getId()).course(courseBuilder.build());
    }
