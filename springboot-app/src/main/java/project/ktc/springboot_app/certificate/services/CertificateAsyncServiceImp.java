 ...
 * certificate processing This
 * service is dedicated to background tasks like PDF generation, cloud upload,
 * and email
 * notifications
 */
@Slf4j
...
public class CertificateAsyncServiceImp implements CertificateAsyncService {
	 ...
	 * asynchronously This
	 * method runs in a separate thread and has its own transaction context Uses
	 * pessimistic locking
