...
/**
 * Request DTO specifically for common discount creation Handles different
...
public class CommonDiscountRequest {
	...
	/**
	 * For GENERAL type: required For REFERRAL type: optional (will use current time
	 * if null)
	 */
	...
	/**
	 * For GENERAL type: required For REFERRAL type: optional (will use far future
	 * date if null)
	 */
