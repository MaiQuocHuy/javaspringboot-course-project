...
public class CertificateServiceImp implements CertificateService {
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<CertificateListDto>>> getAllCertificates(
    ...
    try {
      Page<Certificate> certificatesPage =
          certificateRepository.findAllWithSearch(search, pageable);

      List<CertificateListDto> certificateList =
          certificatesPage.getContent().stream()
              .map(this::mapToCertificateListDto)
              .collect(Collectors.toList());

      PaginatedResponse<CertificateListDto> paginatedResponse =
          PaginatedResponse.<CertificateListDto>builder()
  ...
  public ResponseEntity<ApiResponse<CertificateResponseDto>> getCertificateByCertificateCode(
    ...
    try {
      Optional<Certificate> certificateOpt =
          certificateRepository.findByCertificateCode(certificateCode);
      if (certificateOpt.isEmpty()) {
  ...
  @Override
  public ResponseEntity<ApiResponse<PaginatedResponse<CertificateListDto>>>
      getCertificatesByCourseId(String courseId, Pageable pageable) {
