...
/**
 * Instructor course detail response DTO extending base course information
 * with detailed sections and lessons information
 */
@Data
...
public class InstructorCourseDetailResponseDto extends BaseCourseResponseDto {
    ...
    public InstructorCourseDetailResponseDto(
            // Base fields
            String id, String title, String description, java.math.BigDecimal price,
            project.ktc.springboot_app.course.enums.CourseLevel level, String thumbnailUrl,
            boolean isApproved, LocalDateTime createdAt, LocalDateTime updatedAt,
            List<CategoryInfo> categories, int totalStudents, int sectionCount,
