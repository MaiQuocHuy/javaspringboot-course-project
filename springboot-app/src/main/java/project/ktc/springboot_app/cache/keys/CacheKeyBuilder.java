...
/**
 * Utility class for building cache keys with consistent naming conventions. This class centralizes
 * cache key generation logic to ensure consistency and maintainability across the application.
 *
 * <p>Key Design Principles: - Consistent naming: prefix:operation:identifier:parameters - URL-safe
 * characters only - Deterministic key generation for same inputs - Hierarchical structure for easy
 * pattern matching
 *
 * @author KTC Team
 */
...
public class CacheKeyBuilder {
   ...
   */
  public String buildCoursesListKey(
      int page,
      int size,
      String search,
      String categoryId,
    ...
    String key = String.format(CacheConstants.COURSES_LIST_PATTERN, page, size, filters);
   ...
   * @return formatted cache key
   */
  public String buildSharedCoursesKey(
      int page,
      int size,
      String search,
      String categoryId,
    ...
    String key =
        String.format(
            CacheConstants.COURSES_SHARED_PATTERN,
            page,
            size,
  ...
  public String buildCourseDetailKey(String courseId) {
    String key = String.format(CacheConstants.COURSE_DETAIL_PATTERN, sanitizeValue(courseId));
  ...
  public String buildCourseSlugKey(String slug) {
    String key = String.format(CacheConstants.COURSE_SLUG_PATTERN, sanitizeValue(slug));
   ...
   * @return formatted cache key
   */
  public String buildInstructorCoursesKey(
      String instructorId,
      int page,
      int size,
      String search,
    ...
    String key =
        String.format(
            CacheConstants.INSTRUCTOR_COURSES_PATTERN,
   ...
   */
  public String buildInstructorCoursesKey(
      String instructorId, int page, int size, String search, String status, String sort) {
  ...
  public String buildCategoryDetailKey(String categoryId) {
    String key = String.format(CacheConstants.CATEGORY_DETAIL_PATTERN, sanitizeValue(categoryId));
  ...
  public String buildUserEnrollmentStatusKey(String userId, String courseIds) {
    String key =
        String.format(
            CacheConstants.USER_ENROLLMENT_STATUS_PATTERN,
  ...
  public String buildUserProfileDetailKey(String userEmail) {
    String key =
        String.format(CacheConstants.USER_PROFILE_DETAIL_PATTERN, sanitizeValue(userEmail));
  ...
  public String buildCourseReviewsKey(String courseId, int page, int size, String sort) {
    String key =
        String.format(
            CacheConstants.COURSE_REVIEWS_PATTERN,
  ...
  /**
   * Builds cache key for course reviews (without sort parameter for backward compatibility)
   *
   * @param courseId course identifier
   * @param page page number
   * @param size page size
  ...
  public String buildCourseReviewStatsKey(String courseId) {
    String key = String.format(CacheConstants.COURSE_REVIEW_STATS_PATTERN, sanitizeValue(courseId));
  ...
  public String buildInstructorStatisticsKey(String instructorId) {
    String key =
        String.format(CacheConstants.INSTRUCTOR_STATISTICS_PATTERN, sanitizeValue(instructorId));
  ...
  public String buildInstructorCoursesStatisticsKey(String instructorId) {
    String key =
        String.format(
            CacheConstants.INSTRUCTOR_COURSES_STATISTICS_PATTERN, sanitizeValue(instructorId));
  ...
  public String buildInstructorEarningsStatisticsKey(String instructorId) {
    String key =
        String.format(
            CacheConstants.INSTRUCTOR_EARNINGS_STATISTICS_PATTERN, sanitizeValue(instructorId));
  ...
  public String buildInstructorStudentsStatisticsKey(String instructorId) {
    String key =
        String.format(
            CacheConstants.INSTRUCTOR_STUDENTS_STATISTICS_PATTERN, sanitizeValue(instructorId));
  ...
  public String buildInstructorReviewsStatisticsKey(String instructorId) {
    String key =
        String.format(
            CacheConstants.INSTRUCTOR_REVIEWS_STATISTICS_PATTERN, sanitizeValue(instructorId));
  ...
  public String buildCourseDynamicKey(String courseId) {
    String key = String.format(CacheConstants.COURSE_DYNAMIC_PATTERN, sanitizeValue(courseId));
  ...
  public String buildCategoryPattern(String categoryId) {
    if (categoryId != null && !categoryId.trim().isEmpty()) {
      String pattern =
          CacheConstants.CATEGORIES_CACHE_PREFIX + "*" + sanitizeValue(categoryId) + "*";
  ...
  public String buildInstructorStatisticsPattern(String instructorId) {
    String pattern =
        CacheConstants.INSTRUCTOR_STATISTICS_CACHE_PREFIX + "*" + sanitizeValue(instructorId) + "*";
  ...
  public String buildInstructorCachePattern(String instructorId) {
    String pattern =
        CacheConstants.INSTRUCTOR_COURSES_CACHE_PREFIX + "*" + sanitizeValue(instructorId) + "*";
