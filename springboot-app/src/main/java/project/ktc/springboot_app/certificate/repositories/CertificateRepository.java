...
public interface CertificateRepository extends JpaRepository<Certificate, String> {
  ...
  /**
   * Find certificate by ID with all necessary relationships eagerly loaded Used for async
  ...
  /**
   * Find certificate by ID with pessimistic lock to ensure latest data Used for async processing to
  ...
  /**
   * Find certificate by ID with optimistic force increment lock Alternative locking strategy for
  ...
  /**
   * Update certificate file URL atomically Used to prevent conflicts when updating the file URL
   * after async processing
   */
  @Modifying
  @Query(
      "UPDATE Certificate c SET c.fileUrl = :fileUrl, c.updatedAt = CURRENT_TIMESTAMP "
          + "WHERE c.id = :certificateId")
