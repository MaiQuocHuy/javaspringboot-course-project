...
/**
 * Email service interface for sending emails Supports both synchronous and asynchronous email
 * sending
 */
public interface EmailService {
   ...
   * @return future with email send result
   */
  CompletableFuture<EmailSendResult> sendTemplateEmailAsync(
      String to,
      String subject,
      String templateName,
      java.util.Map<String, Object> templateVariables);
   ...
   * @return future with email send result
   */
  CompletableFuture<EmailSendResult> sendSimpleEmailAsync(
   ...
   */
  CompletableFuture<Long> sendDiscountCodeToAllStudents(String discountId, String subject);
   ...
   * @return CompletableFuture with number of successful sends (1 if successful, 0 if failed)
   */
  ...
  CompletableFuture<Long> sendDiscountCodeToMultipleUsers(
      String discountId, String subject, java.util.List<String> userIds);
}
