...
/**
 * Cache DTO for storing review data in Redis.
 * This DTO provides clean separation between service layer and cache layer,
 * containing only essential review information needed for caching.
 * 
 * @author KTC Team
 */
@Data
