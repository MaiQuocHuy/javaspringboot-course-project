...
public class JwtTokenProvider {
  ...
  public String extractUsername(String token) {
    try {
      ...
      log.error(
          "Cannot extract username from JWT token with invalid signature: {}", e.getMessage());
      throw new InvalidJwtTokenException(
          "Cannot extract username from JWT token with invalid signature", e);
    } catch (Exception e) {
  ...
  public <T> T extractClaim(String token, Function<Claims, T> claimsResolver) {
    try {
      ...
      throw new InvalidJwtTokenException(
          "Cannot extract claim from JWT token with invalid signature", e);
    } catch (Exception e) {
