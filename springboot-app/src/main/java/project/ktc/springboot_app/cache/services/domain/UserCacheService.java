...
/**
 * User-specific cache service that provides high-level caching operations for user profiles.
 * Handles user profile caching, retrieval, and invalidation using the underlying cache service.
 *
 * @author KTC Team
 */
@Service
