...
@Tag(
    ...
    description = "APIs for managing course completion certificates")
...
public class CertificateController {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request - Invalid input or user hasn't completed course",
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<CertificateResponseDto>>
      createCertificate(
          @Parameter(description = "Certificate creation request", required = true)
              @Valid
              @RequestBody
              CreateCertificateDto createCertificateDto) {

    log.info(
        "Admin request to create certificate for user {} and course {}",
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<PaginatedResponse<CertificateListDto>>>
      getAllCertificates(
          @Parameter(description = "Search term for filtering certificates", example = "john")
          ...
          @Parameter(
              ...
              @RequestParam(defaultValue = "issuedAt,desc")
              String sort) {

    log.info(
        "Admin request to get all certificates with search: {}, page: {}, size: {}",
        search,
        page,
        size);
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Forbidden - No access to this certificate",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "404",
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<CertificateResponseDto>>
      getCertificateById(
          @Parameter(description = "Certificate ID", required = true, example = "cert-123")
              @PathVariable
              String id) {
  ...
  @Operation(
      summary = "Get certificate by certificate code",
      description =
          """
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<CertificateResponseDto>>
      getCertificateByCertificateCode(
          @Parameter(
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Forbidden - No access to user's certificates",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "404",
  ...
  public ResponseEntity<
      ...
      getCertificatesByUserId(
          @Parameter(description = "User ID", required = true, example = "user-123") @PathVariable
              String userId,
          @Parameter(description = "Page number (0-based)", example = "0")
              @RequestParam(defaultValue = "0")
              @Min(0)
  ...
  @PreAuthorize(
      "hasRole('INSTRUCTOR') or hasRole('ADMIN') or @courseRepository.existsByIdAndInstructorId(#courseId, authentication.name)")
  @Operation(
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Forbidden - No access to course certificates",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "404",
  ...
  public ResponseEntity<
      ...
      getCertificatesByCourseId(
          @Parameter(description = "Course ID", required = true, example = "course-456")
              @PathVariable
              String courseId,
          @Parameter(description = "Page number (0-based)", example = "0")
              @RequestParam(defaultValue = "0")
  ...
  @Operation(
      ...
      description = "Test endpoint to verify html-to-image API integration")
