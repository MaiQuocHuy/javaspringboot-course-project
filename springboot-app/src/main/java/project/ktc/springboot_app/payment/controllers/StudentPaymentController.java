...
@Tag(
    name = "Student Payment API",
    description = "Endpoints for students to view their payment transactions")
public class StudentPaymentController {
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during payment retrieval",
            content = @Content(mediaType = "application/json"))
      })
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
            description = "Payment not found or not owned by the current user",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during payment detail retrieval",
            content = @Content(mediaType = "application/json"))
      })
  ...
  @Operation(
      summary = "Get student payment statistics",
      description =
          """
