...
public class InstructorLessonController {
	 ...
	 *            The lesson title
	 * @param type
	 *            The lesson type (VIDEO or QUIZ)
	 * @param videoFile
	 *            The video file (required for VIDEO type lessons)
	...
	/**
	 * Update an existing lesson in a section owned by the instructor Endpoint:
	 * PATCH
	 ...
	 * @param title
	 *            The updated lesson title
	 * @param type
	 *            The lesson type (cannot be changed)
	 * @param videoFile
	 *            The video file (optional for VIDEO lessons)
	...
	public ResponseEntity<ApiResponse<UpdateLessonResponseDto>> updateLesson(
			...
			@Parameter(description = "Lesson type (cannot be changed, used for validation only)", required = false, schema = @Schema(allowableValues = {
					"VIDEO", "QUIZ" })) @RequestParam(value = "type", required = false) String type,
	 ...
	 *
	 * @param sectionId
	 *            The ID of the section where the lesson will be created
	 * @param createLessonWithQuizDto
