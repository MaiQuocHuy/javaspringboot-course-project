...
public class PermissionMapper {
  ...
  /**
   * Convert RolePermission entity to PermissionResponseDto with role-specific fields
   *
  ...
  public PermissionUpdateResponse toPermissionUpdateResponse(
    ...
    List<PermissionUpdateResponse.UpdatedPermissionDto> updatedPermissions =
        rolePermissions.stream()
            .map(
                rp ->
                    PermissionUpdateResponse.UpdatedPermissionDto.builder()
  ...
  public ResourceTreeResponse toResourceTreeResponse(
    ...
    ResourceTreeResponse.TreeStatistics statistics =
        ResourceTreeResponse.TreeStatistics.builder()
