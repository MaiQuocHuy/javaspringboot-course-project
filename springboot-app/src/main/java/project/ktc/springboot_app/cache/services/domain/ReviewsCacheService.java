...
/**
 * Review-specific cache service that provides high-level caching operations for course reviews.
...
public class ReviewsCacheService {
  ...
  public void storeCourseReviews(
    ...
    try {
      ...
      String cacheKey =
          cacheKeyBuilder.buildCourseReviewsKey(
      ...
      PaginatedResponse<ReviewCacheDto> cacheDto =
          ReviewCacheMapper.toCachePaginatedDto(paginatedResponse);
  ...
  public PaginatedResponse<ReviewResponseDto> getCourseReviews(String courseId, Pageable pageable) {
    try {
      ...
      PaginatedResponse<ReviewCacheDto> cacheDto =
          (PaginatedResponse<ReviewCacheDto>) cacheService.get(cacheKey);
