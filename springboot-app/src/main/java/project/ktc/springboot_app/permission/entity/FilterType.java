...
/**
 * Filter Type Entity for the new permission system
 * Represents different data access scopes (ALL, OWN)
 * 
 * Note: The ID field directly contains the filter type key (e.g.,
 * "filter-type-001")
 */
@Entity
