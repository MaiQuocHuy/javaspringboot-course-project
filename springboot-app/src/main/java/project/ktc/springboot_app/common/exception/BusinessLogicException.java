 ...
 *
 * <p>This exception is used to indicate that an operation failed due to business rule violations,
 * such as: - Rate limiting - State constraints - Business process violations - Policy enforcement
 * failures
 *
 * @author KTC Team
 * @version 1.0
...
public class BusinessLogicException extends RuntimeException {
  ...
  /**
   * Constructs a new business logic exception with the specified detail message and cause.
   *
   * @param message the detail message
