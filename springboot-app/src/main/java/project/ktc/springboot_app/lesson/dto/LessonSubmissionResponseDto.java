...
/**
 * DTO for API response containing individual student submission information.
 * Used in the lesson submissions endpoint response.
 */
@Data
@Builder
@NoArgsConstructor
...
public class LessonSubmissionResponseDto {
    ...
    @Schema(description = "Submission status", example = "submitted", allowableValues = {"not_submitted", "submitted"})
