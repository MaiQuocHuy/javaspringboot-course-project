 ...
 *
 * <p>Certificate Code Format: [COURSE_PREFIX]-[YEAR]-[SEQUENCE]-[RANDOM_ID] Example:
...
public class CertificateCodeGenerator {
  ...
  /**
   * Generate a unique certificate code based on course title and current timestamp
   *
  ...
  /**
   * Generate course prefix from course title Extracts meaningful characters from the course title
   ...
   *
   * @param certificateCode The code to validate
