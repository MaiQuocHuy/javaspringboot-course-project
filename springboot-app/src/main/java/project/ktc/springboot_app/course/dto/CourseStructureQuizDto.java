...
public class CourseStructureQuizDto {
    ...
    public static class QuizQuestion {
        ...
        @Schema(description = "Answer options", example = "{\"A\": \"Library\", \"B\": \"Framework\", \"C\": \"Language\", \"D\": \"Tool\"}")
        private Map<String, String> options;
        
        @Schema(description = "Correct answer", example = "A")
        private String correctAnswer;
        
        @Schema(description = "Explanation of the correct answer", example = "React is a JavaScript library for building user interfaces")
