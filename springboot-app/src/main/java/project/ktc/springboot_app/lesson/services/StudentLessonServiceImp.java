...
public class StudentLessonServiceImp implements StudentService {
	 ...
	 *
	 * <p>
	 * This method handles lesson completion with the following logic: - If lesson
	 * was previously
	 * completed, it updates the completion timestamp - If first completion, it
	 * creates a new lesson
	 * completion record - Checks and updates course completion status if all
	 ...
	 *
	 * <p>
	 * This method handles quiz submission with the following logic: - If quiz was
	 * previously
	 * submitted, it updates the existing result and completion time - If first
	 * submission, it creates
	 * new quiz result and lesson completion records - Automatically marks lesson as
	 * completed after
	 * successful quiz submission - Checks and updates course completion status if
	 * all lessons are
	 * completed
	 *
	 * @param sectionId
	 ...
	 * @param submitQuizDto
	 *            DTO containing the submitted answers
