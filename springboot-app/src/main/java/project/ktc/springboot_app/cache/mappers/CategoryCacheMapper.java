...
/**
 * Utility class for converting between category DTOs and cache DTOs. This
...
public class CategoryCacheMapper {
	 ...
	 *
	 * @param responseDto
	 *            The CategoryResponseDto to convert
	 ...
	 *
	 * @param cacheDto
	 *            The CategoryCacheDto from cache
	 ...
	 *
	 * @param responseDtos
	 *            List of CategoryResponseDto to convert
	 ...
	 *
	 * @param cacheDtos
	 *            List of CategoryCacheDto from cache
