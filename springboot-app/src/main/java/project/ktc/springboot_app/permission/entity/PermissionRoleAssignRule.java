...
/**
 * Permission Role Assign Rule Entity
 * Defines which permissions can be assigned to which roles
 * Only permissions defined in this table can be assigned to the corresponding
 * role
 */
@Entity
