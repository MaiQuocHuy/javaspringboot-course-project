...
public class AuthServiceImp implements AuthService {
	...
	public ResponseEntity<ApiResponse<Map<String, Object>>> refreshAccessToken(String refreshToken) {
		...
		try {
			RefreshToken existingRefreshToken = refreshTokenRepository.findByToken(refreshToken).orElse(null);
			...
			Map<String, Object> refreshResponse = Map.of("accessToken", newAccessToken, "refreshToken",
