 ...
 * Records payouts to users who referred others through their discount codes
 */
@Entity
...
public class AffiliatePayout extends BaseEntity {
    ...
    /**
     * Link to the discount usage that triggered this payout
     * Can be null if payout is created independently
     */
    @ManyToOne(fetch = FetchType.LAZY)
