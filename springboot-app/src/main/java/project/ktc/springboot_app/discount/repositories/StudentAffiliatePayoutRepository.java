...
/**
 * Repository for student affiliate payout operations
 * Handles queries for affiliate payouts from student perspective
 */
@Repository
public interface StudentAffiliatePayoutRepository extends JpaRepository<AffiliatePayout, String> {
    ...
    @Query("""
            ...
            """)
    Page<AffiliatePayout> findByReferredByUserId(@Param("studentId") String studentId, Pageable pageable);
    ...
    Long countByReferredByUserIdAndPayoutStatus(@Param("studentId") String studentId,
    ...
    BigDecimal sumCommissionAmountByReferredByUserIdAndPayoutStatus(@Param("studentId") String studentId,
            @Param("status") PayoutStatus status);
}
