...
/**
 * Implementation of DiscountService with comprehensive business logic Handles
 * all discount-related
...
public class DiscountServiceImp implements DiscountService {
	...
	public ResponseEntity<ApiResponse<List<DiscountResponseDto>>> getAvailablePublicDiscounts() {
		try {
			...
			List<DiscountResponseDto> responseDtos = availableDiscounts.stream().map(this::convertToDto)
