...
public interface QuizResultRepository extends JpaRepository<QuizResult, String> {
	...
	/**
	 * Check if user can review a specific quiz result For now, all completed
	 * quizzes can be reviewed
	 */
	...
	/**
	 * Find all enrolled students with their submission status for a lesson Returns
	 * both students who
