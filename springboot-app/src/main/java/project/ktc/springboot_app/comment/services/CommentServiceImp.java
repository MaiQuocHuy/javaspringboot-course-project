...
public class CommentServiceImp implements CommentService {
	...
	public PaginatedResponse<CommentResponse> getRootComments(String lessonId, Pageable pageable) {
		...
		List<CommentResponse> responseContent = comments.getContent().stream().map(this::convertToResponseDto)
	...
	private Comment addComment(String lessonId, String content, String parentId, String userId) {
		...
		Comment newComment = Comment.builder().content(content).user(user).lesson(lesson).isDeleted(false).build();
