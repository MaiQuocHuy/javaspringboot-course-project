...
/**
 * Static utility class for mapping between InsDashboardDto and InstructorStatisticsCacheDto Follows
 * the established pattern of CategoryCacheMapper for clean separation of concerns between service
 * DTOs and cache DTOs.
 */
