...
public class ForgotPasswordResponseDto {
	...
	/**
	 * A message confirming that the OTP has been sent. Generic message for security
	 * reasons.
	 */
	...
	/**
	 * The timestamp when the OTP will expire. Helps users understand the urgency of
	 * using the code.
	 */
	private LocalDateTime expiresAt;

	/**
	 * Maximum number of attempts allowed for this OTP. Informs users about the
	 * attempt limit.
	 */
	 ...
	 * @param previousTokensInvalidated
	 *            whether old tokens were invalidated
	...
	/**
	 * Masks an email address for privacy protection. Shows first few characters and
	 * domain while
	 * hiding middle part.
	 *
	 * @param email
