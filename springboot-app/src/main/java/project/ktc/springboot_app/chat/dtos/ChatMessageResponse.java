...
public class ChatMessageResponse {
  ...
  @Schema(
      ...
      example = "TEXT",
      allowableValues = {"TEXT", "FILE", "AUDIO", "VIDEO"})
  private String type;

  @Schema(
      description = "Text content for TEXT type messages",
      example = "Hello everyone! How are you doing with the course?")
  private String content;

  @Schema(
      description = "File URL for FILE type messages",
  ...
  @Schema(
      description = "Audio file URL for AUDIO type messages",
      example = "https://example.com/audio/recording.mp3")
  ...
  @Schema(
      description = "Video file URL for VIDEO type messages",
      example = "https://example.com/videos/explanation.mp4")
  private String videoUrl;

  @Schema(
      description = "Video thumbnail URL for VIDEO type messages",
