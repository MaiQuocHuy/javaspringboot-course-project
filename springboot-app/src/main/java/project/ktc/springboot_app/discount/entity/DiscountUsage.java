...
/**
 * DiscountUsage entity to track when discounts are used Records the actual usage of discount codes
...
public class DiscountUsage {
  ...
  /**
   * The user who referred this purchase (only for REFERRAL type discounts) This is the owner of the
   * referral code used
   */
  @ManyToOne(fetch = FetchType.LAZY)
  ...
  /** The actual discount amount in currency (calculated from course price and discount percent) */
