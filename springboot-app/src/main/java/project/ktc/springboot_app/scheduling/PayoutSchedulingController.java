...
/**
 * Controller for managing and monitoring automatic payout scheduling Admin-only
 * endpoints for
...
public class PayoutSchedulingController {
	...
	/**
	 * Manually trigger automatic payout processing Useful for testing or emergency
	 * processing
	 */
	@PostMapping("/trigger")
	...
	/**
	 * Get current payout eligibility status Shows how many payments are eligible,
	 * waiting, etc.
	 */
	@GetMapping("/status")
	@PreAuthorize("hasRole('ADMIN')")
	...
	/**
	 * Get scheduling configuration and health status Shows current configuration
	 * and system health
	 */
	@GetMapping("/config")
	@PreAuthorize("hasRole('ADMIN')")
	...
	/**
	 * Health check endpoint for the scheduling system Returns the health status of
	 * the automatic
	 * payout system
	 */
	@GetMapping("/health")
	...
	/**
	 * Send test email notification to verify email configuration Useful for testing
	 * email
	 * notification system
	 */
	...
	/**
	 * Get email configuration status and details Shows current email notification
	 * settings
	 */
	...
	/**
	 * Force refresh email configuration Useful for reloading email settings without
	 * restarting the
	 * application
	 */
	...
	/**
	 * Debug endpoint to check payment states and eligibility Useful for
	...
	public ResponseEntity<ApiResponse<Map<String, Object>>> debugPayments() {
		...
		try {
			...
			List<project.ktc.springboot_app.payment.entity.Payment> eligiblePayments = payoutEligibilityService
					.findEligiblePayments();
