...
public class StripeWebhookService {
	...
	/**
	 * Handles successful checkout sessions This is the main event for course
	 * purchases
	 */
	private void handleCheckoutSessionCompleted(Event event) {
		...
		try {
			...
			var paymentOpt = paymentService.findPaymentBySessionIdAndVerifyAmount(
	...
	private String calculateCourseDuration(Course course) {
		try {
			...
			int totalDurationMinutes = course.getSections().stream()
					...
					.mapToInt(
							lesson -> lesson.getContent().getDuration() != null
