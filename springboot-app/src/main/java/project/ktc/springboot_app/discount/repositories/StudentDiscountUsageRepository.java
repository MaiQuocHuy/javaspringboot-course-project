...
/**
 * Repository for student discount usage operations Handles queries for discount
 * usage from student
 * perspective
 */
@Repository
public interface StudentDiscountUsageRepository extends JpaRepository<DiscountUsage, String> {
	...
	/**
	 * Find all discount usages where the current user is the referrer (People using
	 * the student's
	 * discount code)
	 */
	@Query("""
