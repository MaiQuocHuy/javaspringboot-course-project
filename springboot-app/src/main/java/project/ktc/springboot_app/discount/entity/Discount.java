...
/**
 * Discount entity representing discount codes and their properties Supports
 * both GENERAL and
...
public class Discount extends BaseEntity {
	...
	/**
	 * For GENERAL discounts: this should be null For REFERRAL discounts: this is
	 * required and
	...
	public boolean canUserUse(String userId) {
		...
		long userUsageCount = discountUsages.stream().filter(usage -> usage.getUser().getId().equals(userId)).count();
