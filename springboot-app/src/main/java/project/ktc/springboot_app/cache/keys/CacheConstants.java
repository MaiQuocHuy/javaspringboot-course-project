...
/**
 * Central repository for all cache-related constants.
 * This class ensures consistency across the application for cache prefixes,
 * TTL values, and other cache configuration constants.
 * 
 * @author KTC Team
 */
public final class CacheConstants {
        ...
        /**
         * TTL for shared course data cache (30 minutes)
         * Used for courses + categories + enrollmentCounts (non-user-specific data)
         */
         ...
         * Public profiles change less frequently and can be cached longer
         */
        ...
        /**
         * TTL for instructor statistics cache (15 minutes)
         * Statistics data is aggregated from multiple sources and changes less
         * frequently
         */
        public static final Duration INSTRUCTOR_STATISTICS_TTL = Duration.ofMinutes(15);

        /**
         * TTL for instructor courses base info cache (7 minutes)
         * Base course info changes less frequently
         */
        public static final Duration INSTRUCTOR_COURSES_BASE_TTL = Duration.ofMinutes(7);

        /**
         * TTL for instructor courses dynamic info cache (45 seconds)
         * Dynamic info like enrollments and ratings change frequently
         */
        ...
        /**
         * Pattern for course listing cache keys
         * Format: courses:page:0:size:10:filters:search_category_price_level_sort
         */
        public static final String COURSES_LIST_PATTERN = COURSES_CACHE_PREFIX + ":page:%d:size:%d:filters:%s";

        /**
         * Pattern for shared course data cache keys (non-user-specific data)
         * Format:
        ...
        /**
         * Pattern for user-specific enrollment status cache
         * Format: enrollments:user:user-id:courses:course-id1,course-id2,...
         */
        public static final String USER_ENROLLMENT_STATUS_PATTERN = ENROLLMENTS_CACHE_PREFIX + ":user:%s:courses:%s";

        /**
         * Pattern for current user profile cache
         * Format: users:profile:user-email
         */
        public static final String USER_PROFILE_DETAIL_PATTERN = USERS_CACHE_PREFIX + ":profile:%s";

        /**
         * Pattern for course detail cache keys
         * Format: courses:detail:course-id
         */
        public static final String COURSE_DETAIL_PATTERN = COURSES_CACHE_PREFIX + ":detail:%s";

        /**
         * Pattern for course slug lookup
        ...
        /**
         * Pattern for categories list cache
         * Format: categories:list
         */
        public static final String CATEGORIES_LIST_PATTERN = CATEGORIES_CACHE_PREFIX + ":list";

        /**
         * Pattern for category detail cache
         * Format: categories:detail:category-id
         */
        public static final String CATEGORY_DETAIL_PATTERN = CATEGORIES_CACHE_PREFIX + ":detail:%s";

        /**
         * Pattern for course review statistics
         * Format: reviews:course:course-id:stats
         */
        public static final String COURSE_REVIEW_STATS_PATTERN = REVIEWS_CACHE_PREFIX + ":course:%s:stats";

        /**
         * Pattern for instructor courses statistics
         * Format: instructor_statistics:instructor:instructor-id:courses
         */
        public static final String INSTRUCTOR_COURSES_STATISTICS_PATTERN = INSTRUCTOR_STATISTICS_CACHE_PREFIX
                        + ":instructor:%s:courses";

        /**
         * Pattern for instructor earnings statistics
         * Format: instructor_statistics:instructor:instructor-id:earnings
         */
        ...
        /**
         * Pattern for instructor students statistics
         * Format: instructor_statistics:instructor:instructor-id:students
         */
        ...
        /**
         * Pattern for instructor reviews statistics
         * Format: instructor_statistics:instructor:instructor-id:reviews
         */
        public static final String INSTRUCTOR_REVIEWS_STATISTICS_PATTERN = INSTRUCTOR_STATISTICS_CACHE_PREFIX
                        + ":instructor:%s:reviews";

        /**
         * Pattern for user enrollment cache
         * Format: enrollments:user:user-id:page:0:size:10
         */
        public static final String USER_ENROLLMENTS_PATTERN = ENROLLMENTS_CACHE_PREFIX + ":user:%s:page:%d:size:%d";

        /**
         * Pattern for course reviews cache
         * Format: reviews:course:course-id:page:0:size:10:sort:sort-params
         */
        public static final String COURSE_REVIEWS_PATTERN = REVIEWS_CACHE_PREFIX + ":course:%s:page:%d:size:%d:sort:%s";

        /**
         * Pattern for instructor statistics cache
         * Format: instructor_statistics:instructor:instructor-id
         */
        public static final String INSTRUCTOR_STATISTICS_PATTERN = INSTRUCTOR_STATISTICS_CACHE_PREFIX
                        + ":instructor:%s";

        /**
         * Pattern for instructor courses base info cache
         * Format:
        ...
        /**
         * Pattern for course dynamic info cache
         * Format: instructor_courses:course:course-id:dynamic
         */
