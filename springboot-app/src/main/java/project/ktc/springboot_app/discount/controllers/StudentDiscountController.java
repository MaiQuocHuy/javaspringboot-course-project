...
/**
 * REST Controller for student discount operations Allows students to view their discount usage and
 * affiliate payouts
 */
@RestController
...
@Slf4j
@Tag(
    name = "Student Discount API",
    description = "API for student discount and affiliate operations")
public class StudentDiscountController {
  ...
  /**
   * Get discount usages where the current student is the referrer (People using the student's
   * discount code)
   *
  ...
  @Operation(
      summary = "Get student discount usages",
      description =
          """
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<
              PaginatedResponse<StudentDiscountUsageResponseDto>>>
      getDiscountUsages(@PageableDefault(size = 10) Pageable pageable) {

    log.info(
        "Student requesting discount usages with pagination: page={}, size={}",
  ...
  @Operation(
      summary = "Get student affiliate payouts",
      description =
          """
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<
              PaginatedResponse<StudentAffiliatePayoutResponseDto>>>
      getAffiliatePayouts(@PageableDefault(size = 10) Pageable pageable) {

    log.info(
        "Student requesting affiliate payouts with pagination: page={}, size={}",
        pageable.getPageNumber(),
        pageable.getPageSize());
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<StudentAffiliatePayoutStatisticsDto>>
