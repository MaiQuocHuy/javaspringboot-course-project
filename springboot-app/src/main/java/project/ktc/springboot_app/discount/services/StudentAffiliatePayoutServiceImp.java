...
public class StudentAffiliatePayoutServiceImp implements StudentAffiliatePayoutService {
    ...
    public ResponseEntity<ApiResponse<PaginatedResponse<StudentAffiliatePayoutResponseDto>>> getAffiliatePayouts(
        ...
        log.info("Getting affiliate payouts for student: {}, page: {}, size: {}",
        ...
        try {
            ...
            log.info("Successfully retrieved {} affiliate payouts for student: {}",
                    responsePage.getTotalElements(), studentId);

            return ApiResponseUtil.success(paginatedResponse,
                    "Student affiliate payouts retrieved successfully");
    ...
    public ResponseEntity<ApiResponse<StudentAffiliatePayoutStatisticsDto>> getAffiliatePayoutStatistics() {
        ...
        try {
            ...
            Long pendingPayouts = studentAffiliatePayoutRepository.countByReferredByUserIdAndPayoutStatus(studentId,
                    PayoutStatus.PENDING);
            Long paidPayouts = studentAffiliatePayoutRepository.countByReferredByUserIdAndPayoutStatus(studentId,
                    PayoutStatus.PAID);
            Long cancelledPayouts = studentAffiliatePayoutRepository.countByReferredByUserIdAndPayoutStatus(studentId,
            ...
            BigDecimal pendingCommissionAmount = studentAffiliatePayoutRepository
                    .sumCommissionAmountByReferredByUserIdAndPayoutStatus(studentId, PayoutStatus.PENDING);
            BigDecimal paidCommissionAmount = studentAffiliatePayoutRepository
                    .sumCommissionAmountByReferredByUserIdAndPayoutStatus(studentId, PayoutStatus.PAID);
            BigDecimal cancelledCommissionAmount = studentAffiliatePayoutRepository
                    .sumCommissionAmountByReferredByUserIdAndPayoutStatus(studentId, PayoutStatus.CANCELLED);
            ...
            StudentAffiliatePayoutStatisticsDto statistics = StudentAffiliatePayoutStatisticsDto.builder()
                    ...
                    .totalCommissionAmount(totalCommissionAmount != null ? totalCommissionAmount : BigDecimal.ZERO)
                    .pendingCommissionAmount(
                            pendingCommissionAmount != null ? pendingCommissionAmount : BigDecimal.ZERO)
                    .paidCommissionAmount(paidCommissionAmount != null ? paidCommissionAmount : BigDecimal.ZERO)
            ...
            return ApiResponseUtil.success(statistics,
                    "Student affiliate payout statistics retrieved successfully");
