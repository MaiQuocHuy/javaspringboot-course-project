...
@Tag(
    name = "Instructor Section Lesson API",
    description = "Endpoints for managing lessons in sections for instructors")
public class InstructorLessonController {
  ...
  /**
   * Get section with all its lessons for an instructor Endpoint: GET
   * /api/instructor/{sectionId}/lessons
   *
  ...
  /**
   * Create a new lesson in a section owned by the instructor Endpoint: POST
   * /api/instructor/{sectionId}/lessons
   *
   * @param sectionId The ID of the section
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = CreateLessonResponseDto.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description =
                "Validation failed - missing video file for VIDEO lesson, invalid lesson type, or invalid video format",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - instructor does not own the section",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
  ...
  public ResponseEntity<ApiResponse<CreateLessonResponseDto>> createLesson(
      @Parameter(description = "Section ID where the lesson will be created", required = true)
          @PathVariable
          String sectionId,
      ...
      @Parameter(
              ...
              required = true,
              schema = @Schema(allowableValues = {"VIDEO", "QUIZ"}))
          @RequestParam("type")
          String type,
      @Parameter(description = "Video file for VIDEO lessons (max 100MB)", required = false)
          @RequestPart(value = "videoFile", required = false)
          MultipartFile videoFile) {

    // Create DTO from request parameters
    CreateLessonDto createLessonDto = CreateLessonDto.builder().title(title).type(type).build();

    return instructorLessonService.createLesson(sectionId, createLessonDto, videoFile);
  }

  /**
   * Update an existing lesson in a section owned by the instructor Endpoint: PATCH
   * /api/instructor/{sectionId}/lessons/{lessonId}
   *
   * @param sectionId The ID of the section
   ...
   */
  @PatchMapping(
      value = "/{sectionId}/lessons/{lessonId}",
      ...
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = UpdateLessonResponseDto.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description =
                "Validation failed - invalid lesson type change, invalid video format, or lesson not in section",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - instructor does not own the section",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during lesson update",
            content = @Content(mediaType = "application/json"))
      })
  public ResponseEntity<ApiResponse<UpdateLessonResponseDto>> updateLesson(
      @Parameter(description = "Section ID where the lesson belongs", required = true) @PathVariable
          String sectionId,
      @Parameter(description = "Lesson ID to update", required = true) @PathVariable
          String lessonId,
      @Parameter(description = "Updated lesson title (optional)", required = false)
          @RequestParam(value = "title", required = false)
          String title,
      @Parameter(
              description = "Lesson type (cannot be changed, used for validation only)",
              required = false,
              schema = @Schema(allowableValues = {"VIDEO", "QUIZ"}))
          @RequestParam(value = "type", required = false)
          String type,
      @Parameter(description = "Video file for VIDEO lessons (optional)", required = false)
          @RequestPart(value = "videoFile", required = false)
          MultipartFile videoFile) {

    // Create DTO from request parameters
    UpdateLessonDto updateLessonDto = UpdateLessonDto.builder().title(title).type(type).build();

    return instructorLessonService.updateLesson(sectionId, lessonId, updateLessonDto, videoFile);
  }

  /**
   * Delete a lesson from a section owned by the instructor Endpoint: DELETE
   * /api/instructor/{sectionId}/lessons/{lessonId}
   *
   * @param sectionId The ID of the section
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Validation failed - lesson not in section",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - instructor does not own the section",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during lesson deletion",
            content = @Content(mediaType = "application/json"))
      })
  public ResponseEntity<ApiResponse<String>> deleteLesson(
      @Parameter(description = "Section ID where the lesson belongs", required = true) @PathVariable
          String sectionId,
      @Parameter(description = "Lesson ID to delete", required = true) @PathVariable
          String lessonId) {
  ...
  /**
   * Reorder lessons within a section owned by the instructor Endpoint: PATCH
   * /api/instructor/{sectionId}/lessons/reorder
   *
   * @param sectionId The ID of the section
   * @param reorderLessonsDto The lesson reorder data containing lesson IDs in intended order
   * @return ApiResponse with success message
   */
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Validation failed - invalid lesson order, missing IDs, or duplicate IDs",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - instructor does not own the section",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during lesson reordering",
            content = @Content(mediaType = "application/json"))
      })
  public ResponseEntity<ApiResponse<String>> reorderLessons(
      @Parameter(description = "Section ID where the lessons belong", required = true) @PathVariable
          String sectionId,
      @Parameter(
              description = "Request body containing lesson IDs in intended order",
              required = true)
          @Valid
          @RequestBody
  ...
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            description = "Lesson completion recorded successfully",
            content =
                @Content(
                    mediaType = "application/json",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid request - lesson does not belong to section",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Access denied - instructor does not own this section",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
            description = "Section or lesson not found",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during lesson completion",
            content = @Content(mediaType = "application/json"))
      })
  public ResponseEntity<ApiResponse<String>> completeLesson(
      @Parameter(description = "Section ID where the lesson belongs", required = true) @PathVariable
          String sectionId,
      @Parameter(description = "Lesson ID to mark as completed", required = true) @PathVariable
          String lessonId) {
  ...
  /**
   * Create a new lesson with quiz in a single transaction Endpoint: POST
   * /api/instructor/sections/{sectionId}/lessons/with-quiz
   *
   * @param sectionId The ID of the section where the lesson will be created
   * @param createLessonWithQuizDto The lesson and quiz creation data
   * @return LessonWithQuizResponseDto containing the created lesson and quiz details
   */
  @PostMapping("/{sectionId}/lessons/with-quiz")
  @Operation(
      summary = "Create lesson with quiz",
      description =
          """
  ...
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "201",
            description = "Lesson with quiz created successfully",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = LessonWithQuizResponseDto.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid request - validation errors in lesson or quiz data",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Access denied - instructor does not own this section",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during lesson and quiz creation",
            content = @Content(mediaType = "application/json"))
      })
  public ResponseEntity<ApiResponse<LessonWithQuizResponseDto>> createLessonWithQuiz(
      @Parameter(description = "Section ID where the lesson will be created", required = true)
          @PathVariable
          String sectionId,
      @Parameter(description = "Lesson and quiz creation data", required = true) @Valid @RequestBody
          CreateLessonWithQuizDto createLessonWithQuizDto) {
  ...
  @Operation(
      summary = "Update quiz questions for a lesson",
      description =
          """
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid request - validation errors in quiz data",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Access denied - instructor does not own this section",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during quiz update",
            content = @Content(mediaType = "application/json"))
      })
  public ResponseEntity<ApiResponse<UpdateQuizResponseDto>> updateQuizQuestions(
      @Parameter(description = "Section ID where the lesson belongs", required = true) @PathVariable
          String sectionId,
      @Parameter(description = "Lesson ID to update quiz questions for", required = true)
          @RequestParam
          String lessonId,
      @Parameter(description = "Updated quiz data", required = true) @Valid @RequestBody
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid section/lesson relationship or lesson is not a quiz type"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - instructor does not own the course"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
            description = "Section or lesson not found"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during quiz questions retrieval")
      })
  public ResponseEntity<ApiResponse<PaginatedResponse<QuizQuestionResponseDto>>> getQuizQuestions(
      @Parameter(description = "Section ID containing the lesson", required = true) @PathVariable
          String sectionId,
      @Parameter(description = "Lesson ID containing the quiz questions", required = true)
          @PathVariable
          String lessonId,
  ...
  /**
   * Get lesson submissions for instructors Endpoint: GET
   * /api/instructor/sections/lessons/{lessonId}/submissions
   *
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid lesson - not a quiz type or invalid pagination parameters"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - instructor does not own the lesson"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
            description = "Lesson not found"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during submissions retrieval")
      })
  public ResponseEntity<ApiResponse<LessonSubmissionsResponseDto>> getSubmissions(
      @Parameter(description = "Lesson ID to get submissions for", required = true) @PathVariable
          String lessonId,
      @Parameter(description = "Page number (0-based)") @RequestParam(defaultValue = "0") @Min(0)
          int page,
  ...
  /**
   * Get submission details for instructors Endpoint: GET
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Bad request - lesson and submission do not match"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - instructor does not own the course"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
            description = "Submission or lesson not found"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during submission details retrieval")
      })
  public ResponseEntity<ApiResponse<SubmissionDetailResponseDto>> getSubmissionDetails(
      ...
      @Parameter(description = "Submission ID", required = true) @PathVariable
          String submissionId) {
