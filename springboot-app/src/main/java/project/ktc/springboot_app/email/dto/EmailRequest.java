...
public class EmailRequest {
  ...
  @Builder.Default private Map<String, Object> templateVariables = Map.of();
  ...
  @Builder.Default private boolean sendAfterCommit = false;

  @Builder.Default private EmailPriority priority = EmailPriority.NORMAL;
