...
public interface CategoryService {
    ...
    ResponseEntity<ApiResponse<Page<CategoryResponseDto>>> getAllCategories(String search, Pageable pageable);
    ...
    // Update category
    ResponseEntity<ApiResponse<CategoryResponseDto>> updateCategory(String id, CategoryRequestDto requestDto);
