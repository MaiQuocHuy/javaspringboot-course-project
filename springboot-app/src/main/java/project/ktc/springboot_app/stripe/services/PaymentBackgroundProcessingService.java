...
/**
 * Service to handle background processing tasks for completed payments This
 * keeps the main webhook
...
public class PaymentBackgroundProcessingService {
	...
	/**
	 * Processes all background tasks for a completed payment asynchronously This
	 * method is called
	...
	/**
	 * Processes affiliate payouts if applicable Note: Affiliate processing will be
	 * handled separately
