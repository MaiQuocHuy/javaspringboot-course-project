 ...
 *
 * <p>
 * This configuration provides: - Redis connection factory with Lettuce client -
 * Custom
 * RedisTemplate with JSON serialization - Cache manager with different TTL for
 * different cache
...
public class RedisConfig {
	...
	/**
	 * Local Redis Connection Factory for development profile - Uses local Redis
	 * server without SSL -
	...
	/**
	 * Remote Redis Connection Factory for production profile - Uses remote Redis
	 * server with SSL
