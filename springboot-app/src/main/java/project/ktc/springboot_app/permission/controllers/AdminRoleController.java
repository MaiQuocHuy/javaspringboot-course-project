...
/**
 * Admin Role Controller for role management operations Provides API endpoints for CRUD operations
...
public class AdminRoleController {
  ...
  public ResponseEntity<ApiResponse<RoleResponseDto>> createRole(
    ...
    RoleResponseDto response =
        RoleResponseDto.builder().id(createdRole.getId()).name(createdRole.getRole()).build();
  ...
  public ResponseEntity<ApiResponse<RoleResponseDto>> updateRole(
    ...
    RoleResponseDto response =
        RoleResponseDto.builder().id(updatedRole.getId()).name(updatedRole.getRole()).build();
