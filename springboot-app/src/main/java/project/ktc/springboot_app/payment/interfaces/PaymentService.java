...
public interface PaymentService {
   ...
   */
  Optional<Payment> findPaymentBySessionIdAndVerifyAmount(
  ...
  /**
   * Retrieves detailed information about a specific payment for the currently authenticated
   * student.
   *
  ...
  /**
   * Finds completed payment by course ID and user ID This is used to check if user has already
