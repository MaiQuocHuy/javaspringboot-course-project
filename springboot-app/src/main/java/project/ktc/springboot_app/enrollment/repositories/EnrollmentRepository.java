...
public interface EnrollmentRepository extends JpaRepository<Enrollment, String> {
  ...
  List<Enrollment> findByUserIdWithCourseAndInstructor(
      @Param("userId") String userId, @Param("status") Enrollment.CompletionStatus status);
  ...
  @Query(
      "SELECT COUNT(e) FROM Enrollment e WHERE e.user.id = :userId AND e.completionStatus = :status")
  Long countEnrollmentsByUserIdAndStatus(
      @Param("userId") String userId, @Param("status") Enrollment.CompletionStatus status);
  ...
  @Query(
      "SELECT e FROM Enrollment e "
          ...
          + "WHERE e.user.id = :userId "
          + "ORDER BY e.enrolledAt DESC")
  List<Enrollment> findRecentEnrollmentsByUserId(
