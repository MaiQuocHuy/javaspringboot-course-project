...
public interface InstructorDiscountUsageService {
   ...
   */
  ResponseEntity<ApiResponse<PaginatedResponse<InstructorDiscountUsageResponseDto>>>
      getDiscountUsages(Pageable pageable);

  /**
   * Get all discount usages for courses owned by the instructor with search and filtering
   *
