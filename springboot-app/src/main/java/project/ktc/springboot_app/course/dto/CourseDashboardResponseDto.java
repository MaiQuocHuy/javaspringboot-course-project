...
/**
 * Course dashboard response DTO extending base course information
 * with dashboard-specific fields like permissions and revenue
 */
@Data
...
public class CourseDashboardResponseDto extends BaseCourseResponseDto {
    ...
    public CourseDashboardResponseDto(
            // Base fields
            String id, String title, String description, BigDecimal price,
