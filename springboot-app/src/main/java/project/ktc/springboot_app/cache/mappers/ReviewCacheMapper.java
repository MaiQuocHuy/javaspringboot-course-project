...
/**
 * Utility class for converting between review DTOs and cache DTOs.
 * This mapper ensures clean separation between service layer and cache layer,
 * following the established codebase pattern for cache operations.
 * 
 * @author KTC Team
 */
public class ReviewCacheMapper {
    ...
    public static List<ReviewCacheDto> toCacheDtoList(List<ReviewResponseDto> responseDtos) {
        ...
        return responseDtos.stream()
                .map(ReviewCacheMapper::toCacheDto)
    ...
    public static List<ReviewResponseDto> fromCacheDtoList(List<ReviewCacheDto> cacheDtos) {
        ...
        return cacheDtos.stream()
                .map(ReviewCacheMapper::fromCacheDto)
                .collect(Collectors.toList());
    }
