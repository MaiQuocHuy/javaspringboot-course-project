...
@Slf4j
@Tag(
    name = "Nested Set Comments",
    description = "Production-ready threaded comment system using Nested Set Model")
...
public class CommentController {
  ...
  @Operation(
      ...
      description =
          "Create a new comment or reply using the Nested Set Model. Supports unlimited nesting depth with optimized performance.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "201",
        ...
        @ApiResponse(
            responseCode = "404",
            description = "Lesson or parent comment not found",
            content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
      })
  @PostMapping
  @PreAuthorize("hasRole('STUDENT') or hasRole('INSTRUCTOR') or hasRole('ADMIN')")
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<CommentResponse>>
      createComment(
          @Parameter(description = "Lesson ID", required = true) @PathVariable String lessonId,
          @Parameter(description = "Comment creation request", required = true) @Valid @RequestBody
  ...
  @Operation(
      summary = "Get paginated root comments",
      description = "Get root comments with pagination for initial page load.")
  @GetMapping("/roots")
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<PaginatedResponse<CommentResponse>>>
  ...
  @Operation(
      ...
      description =
          "Get all replies (subtree) for a specific comment using efficient nested set queries.")
  @GetMapping("/{commentId}/replies")
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<List<CommentResponse>>>
      getCommentReplies(
          @Parameter(description = "Lesson ID", required = true) @PathVariable String lessonId,
  ...
  @Operation(
      ...
      description = "Update an existing comment. Only the comment author can update their comment.")
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<CommentResponse>>
      updateComment(
          @Parameter(description = "Lesson ID", required = true) @PathVariable String lessonId,
          @Parameter(description = "Comment ID", required = true) @PathVariable String commentId,
          @Parameter(description = "Comment update request", required = true) @Valid @RequestBody
  ...
  @Operation(
      summary = "Delete comment subtree",
      description =
          "Soft delete a comment and all its replies. Only the comment author can delete.")
  ...
  @Operation(
      ...
      description = "Get total number of comments for a lesson")
  @GetMapping("/count")
