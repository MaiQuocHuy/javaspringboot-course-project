 ...
 * cache key generation logic to ensure consistency and maintainability across
 * the application.
 *
 * <p>
 * Key Design Principles: - Consistent naming:
 * prefix:operation:identifier:parameters - URL-safe
 * characters only - Deterministic key generation for same inputs - Hierarchical
 * structure for easy
 * pattern matching
 *
 * @author KTC Team
...
public class CacheKeyBuilder {
	...
	public String buildInstructorCoursesKey(
			...
			Object isPublished,
			String type) {
		String filters = buildParameterString(
	...
	public String buildUserProfileDetailKey(String userEmail) {
		String key = String.format(CacheConstants.USER_PROFILE_DETAIL_PATTERN, sanitizeValue(userEmail));
	...
	public String buildInstructorStatisticsKey(String instructorId) {
		String key = String.format(CacheConstants.INSTRUCTOR_STATISTICS_PATTERN, sanitizeValue(instructorId));
