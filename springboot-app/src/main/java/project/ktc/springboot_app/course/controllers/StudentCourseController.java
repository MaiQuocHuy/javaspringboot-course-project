...
public class StudentCourseController {
  ...
  @Operation(
      ...
      description =
          "Retrieve a paginated list of all courses the currently authenticated student is enrolled in, including course metadata and progress status with search, filter, and sort capabilities.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<PaginatedResponse<MyEnrolledCourseDto>>>
      getMyCourses(
          @Parameter(description = "Search by course title or instructor name")
              @RequestParam(required = false)
              String search,
          @Parameter(
                  description =
                      "Filter by course progress (completed: 100% progress, in_progress: 0-99% progress, not_started: 0% progress)",
                  example = "completed")
              @RequestParam(required = false)
              String progressFilter,
          @Parameter(
                  description = "Filter by enrollment status (IN_PROGRESS, COMPLETED)",
                  example = "IN_PROGRESS")
              @RequestParam(required = false)
              Enrollment.CompletionStatus status,
          @Parameter(
                  description = "Sort by field (recent, progress, title, instructor)",
                  example = "recent")
    ...
    log.info(
        "Fetching enrolled courses with search: {}, progressFilter: {}, status: {}, sortBy: {}, sortDirection: {}, pagination: {}",
        search,
        progressFilter,
        status,
        sortBy,
  ...
  @GetMapping("/all")
  @Operation(
      summary = "Get my enrolled courses without pagination",
      description =
          "Retrieve a list of all courses the currently authenticated student is enrolled in, including course metadata and progress status with search and filter capabilities.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<List<MyEnrolledCourseDto>>>
      getMyCoursesAll(
          @Parameter(description = "Search by course title or instructor name")
              @RequestParam(required = false)
              String search,
  ...
  @GetMapping("/recent")
  @Operation(
      summary = "Get 3 most recent enrolled courses",
      description =
          "Retrieve the 3 most recently enrolled courses for the currently authenticated student, ordered by enrollment date.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Retrieve comprehensive dashboard statistics for the currently authenticated student including total courses, completed courses, in-progress courses, and lessons completed.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<StudentDashboardStatsDto>>
      getDashboardStats() {
  ...
  @Operation(
      summary = "Get recent student activities",
      description =
          "Retrieve recent activities for the currently authenticated student including course enrollments, lesson completions, and quiz submissions.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<List<StudentActivityDto>>>
      getRecentActivities(
          @Parameter(description = "Maximum number of activities to return (default: 20)")
  ...
  @GetMapping("/{id}")
  @Operation(
      summary = "Get course sections and lessons",
      description =
          "Retrieve all sections and lessons of a specific course for the enrolled student.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Retrieve the complete structure of a specific course for the enrolled student, including all sections, lessons, videos, and quiz questions.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<
              List<project.ktc.springboot_app.course.dto.CourseStructureSectionDto>>>
      getCourseStructure(
  ...
  @Operation(
      ...
      description =
          "Retrieve the real-time progress of a specific course for the enrolled student, including completion status and summary statistics.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<CourseProgressDto>>
      getCourseProgress(
          @Parameter(description = "Course ID", required = true) @PathVariable String courseId) {
