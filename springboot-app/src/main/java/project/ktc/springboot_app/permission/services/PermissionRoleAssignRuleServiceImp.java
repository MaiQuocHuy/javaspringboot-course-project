...
/**
 * Implementation of PermissionRoleAssignRuleService Handles business logic for permission-role
...
public class PermissionRoleAssignRuleServiceImp implements PermissionRoleAssignRuleService {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(PermissionRoleAssignRuleServiceImp.class);
  ...
  public List<PermissionRoleAssignRule> getRolesByPermission(String permissionId) {
    ...
    List<PermissionRoleAssignRule> rules =
        assignRuleRepository.findRolesByPermissionId(permissionId);
  ...
  public PermissionRoleAssignRule createAssignmentRule(
    ...
    PermissionRoleAssignRule existingRule =
        assignRuleRepository.findByRoleIdAndPermissionId(roleId, permissionId);
    ...
    PermissionRoleAssignRule newRule =
        PermissionRoleAssignRule.builder()
            .role(role)
            .permission(permission)
            .isActive(isActive)
