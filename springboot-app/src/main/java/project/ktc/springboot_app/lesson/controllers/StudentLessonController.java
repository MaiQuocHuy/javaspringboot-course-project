...
@Tag(
    name = "Student Section Lesson API",
    description = "Endpoints for managing lessons in sections for students")
public class StudentLessonController {
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid request - missing answers or lesson validation failed",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Access denied - student not enrolled in course",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
            description = "Section, lesson, or quiz questions not found",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            description = "Server error during quiz submission",
            content = @Content(mediaType = "application/json"))
      })
  public ResponseEntity<ApiResponse<QuizSubmissionResponseDto>> submitQuiz(
      @Parameter(description = "Section ID where the lesson belongs", required = true) @PathVariable
          String sectionId,
      @Parameter(description = "Lesson ID with the quiz to submit", required = true) @PathVariable
          String lessonId,
      @Parameter(description = "Quiz answers to submit", required = true) @Valid @RequestBody
