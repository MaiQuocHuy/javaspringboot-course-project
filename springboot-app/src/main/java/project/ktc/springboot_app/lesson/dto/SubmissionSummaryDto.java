...
/**
 * DTO containing summary statistics for lesson submissions. Provides aggregated data about student
 * submissions for a specific lesson.
 */
@Data
@Builder
@NoArgsConstructor
...
public class SubmissionSummaryDto {
  ...
  @Schema(
      description = "Average score of all submissions (null if no submissions)",
      example = "78.5")
