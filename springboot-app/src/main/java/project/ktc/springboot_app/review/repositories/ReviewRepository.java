...
public interface ReviewRepository extends JpaRepository<Review, String> {
  ...
  Optional<Review> findByUserIdAndCourseId(
      @Param("userId") String userId, @Param("courseId") String courseId);
  ...
  @Query("SELECT r FROM Review r " + "JOIN FETCH r.course c " + "WHERE r.user.id = :userId")
  ...
  @Query(
      "SELECT r.rating, COUNT(r) FROM Review r WHERE r.course.id = :courseId GROUP BY r.rating ORDER BY r.rating DESC")
