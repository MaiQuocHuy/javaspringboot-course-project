...
public class AdminAffiliateController {
    ...
    @GetMapping("/payouts")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('affiliate:READ')")
    @Operation(summary = "Get affiliate payouts", description = """
            ...
            **Permissions Required:**
            - ADMIN role OR affiliate:READ permission
            """)
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "Forbidden - Admin role or affiliate:READ permission required"),
    ...
    public ResponseEntity<ApiResponse<AffiliateStatisticsResponseDto>> getAffiliateStatistics() {
        ...
        return ResponseEntity.ok(ApiResponse.success(statistics, "Affiliate statistics retrieved successfully"));
    }
    ...
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('affiliate:WRITE')")
    @Operation(summary = "Mark payout as paid", description = """
            ...
            **Permissions Required:**
            - ADMIN role OR affiliate:WRITE permission
            """)
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized - Invalid or missing token"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "Forbidden - Admin role or affiliate:WRITE permission required"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Payout not found"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ...
    public ResponseEntity<ApiResponse<AffiliatePayoutResponseDto>> cancelPayout(
        ...
        AffiliatePayoutResponseDto payout = adminAffiliatePayoutService.cancelPayout(id, cancelRequest.getReason());
    ...
    public ResponseEntity<ApiResponse<String>> bulkActionPayouts(@RequestBody BulkPayoutActionRequestDto bulkRequest) {
    ...
    public ResponseEntity<byte[]> exportPayouts(
        ...
        return ResponseEntity.ok()
                ...
                .header("Content-Disposition", "attachment; filename=\"affiliate_payouts_" + LocalDate.now() + ".csv\"")
                .body(csvData);
    }
}
