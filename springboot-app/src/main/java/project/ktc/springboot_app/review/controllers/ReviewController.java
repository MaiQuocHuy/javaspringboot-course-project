...
public class ReviewController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Conflict - user has already reviewed this course")
    })
    public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<ReviewResponseDto>> createReview(
            @Parameter(description = "Course ID", required = true, example = "course-uuid-123") @PathVariable("id") String courseId,
            @Parameter(description = "Review data", required = true) @Valid @RequestBody CreateReviewDto reviewDto) {
    ...
    public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<PaginatedResponse<ReviewResponseDto>>> getCourseReviews(
            @Parameter(description = "Course ID", required = true, example = "course-uuid-123") @PathVariable("id") String courseId,
        ...
        log.info("Received request to get reviews for course: {} with page: {}, size: {}", courseId, page, size);
