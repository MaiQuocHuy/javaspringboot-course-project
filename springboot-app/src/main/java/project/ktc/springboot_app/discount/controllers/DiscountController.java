...
/**
 * REST Controller for discount management operations All endpoints require
	...
	public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<DiscountEmailResponse>> sendDiscountEmail(
		...
		try {
			...
			if (request.getUserIds() != null && !request.getUserIds().isEmpty()) {
				...
				message = String.format("Successfully sent discount emails to %d students", totalRecipients);
			}
