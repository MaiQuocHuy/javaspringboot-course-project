...
public class CloudinaryServiceImp implements CloudinaryService {
  ...
  public DocumentUploadResponseDto uploadDocument(MultipartFile file) {
    ...
    try {
      ...
      String publicId =
          "instructor-documents/" + generatePublicIdForDocuments(file.getOriginalFilename());
  ...
  public VideoMetadataResponseDto getVideoMetadata(String videoUrlOrPublicId) throws IOException {
    ...
    try {
      ...
      Long sizeBytes =
          resourceDetails.get("bytes") != null
  ...
  /**
   * Generate download URL for certificate PDF with attachment flag This forces browsers to download
