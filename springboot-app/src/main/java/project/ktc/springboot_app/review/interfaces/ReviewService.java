...
public interface ReviewService {
	 ...
	 *
	 * @param courseId
	 *            the ID of the course to review
	 * @param reviewDto
	 *            the review data
	 ...
	 */
	ResponseEntity<ApiResponse<PaginatedResponse<ReviewResponseDto>>> getCourseReviews(
	 ...
	 * @param reviewDto
	 *            the updated review data (partial)
	 ...
	 */
	ResponseEntity<ApiResponse<PaginatedResponse<StudentReviewResponseDto>>> getStudentReviews(
			Pageable pageable);
	 ...
	 * @return ResponseEntity with paginated reviews
	 */
	ResponseEntity<ApiResponse<PaginatedResponse<ReviewResponseDto>>> getCourseReviewsBySlug(
