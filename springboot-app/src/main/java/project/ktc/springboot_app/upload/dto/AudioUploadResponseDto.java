...
public class AudioUploadResponseDto {
  ...
  @Schema(
      description = "Secure HTTPS URL of the uploaded audio",
      example =
          "https://res.cloudinary.com/example/video/upload/v1234567890/course-audio/audio_1234567890_abcd1234.mp3")
  private String url;

  @Schema(
      description = "Public ID for the audio file",
      example = "course-audio/audio_1234567890_abcd1234")
