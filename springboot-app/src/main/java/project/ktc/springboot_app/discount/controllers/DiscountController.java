...
public class DiscountController {
         ...
         * Only users with ADMIN role can create discounts
         */
        @PostMapping
        @PreAuthorize("hasRole('ADMIN')")
        @Operation(summary = "Create a new discount", description = "Creates a new discount with the specified parameters. "
                        +
        ...
        @ApiResponses(value = {
                        ...
                        @ApiResponse(responseCode = "404", description = "Owner user not found (for REFERRAL type)"),
                        @ApiResponse(responseCode = "409", description = "Discount code already exists"),
                        @ApiResponse(responseCode = "500", description = "Internal server error")
        })
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<DiscountResponseDto>> createDiscount(
                        @Valid @RequestBody CreateDiscountRequest request) {

                log.info("Admin creating discount with code: {} and type: {}", request.getCode(), request.getType());
         ...
         */
        @GetMapping
        @Operation(summary = "Get all discounts", description = "Retrieves all discounts with pagination and sorting. Only ADMIN users can access this endpoint.")
        @PreAuthorize("hasRole('ADMIN')")
        @ApiResponses(value = {
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<PaginatedResponse<DiscountResponseDto>>> getAllDiscounts(
                ...
                log.info("Admin retrieving all discounts - page: {}, size: {}, sort: {} {}",
        ...
        @PreAuthorize("hasRole('ADMIN')")
        @Operation(summary = "Get discounts by type", description = "Retrieves discounts filtered by type (GENERAL or REFERRAL). Only ADMIN users can access this endpoint.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Discounts retrieved successfully"),
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<PaginatedResponse<DiscountResponseDto>>> getDiscountsByType(
                        @Parameter(description = "Discount type", example = "GENERAL", required = true) @PathVariable DiscountType type,
        ...
        @GetMapping("/{id}")
        @PreAuthorize("hasRole('ADMIN')")
        @Operation(summary = "Get discount by ID", description = "Retrieves a specific discount by its unique identifier. Only ADMIN users can access this endpoint.")
        @ApiResponses(value = {
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<DiscountResponseDto>> getDiscountById(
                        @Parameter(description = "Discount ID", example = "discount-uuid-123", required = true) @PathVariable String id) {
        ...
        @Operation(summary = "Get discount by code", description = "Retrieves a specific discount by its code. Only ADMIN users can access this endpoint.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Discount retrieved successfully"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Invalid or missing JWT token"),
                        @ApiResponse(responseCode = "403", description = "Forbidden - User does not have ADMIN role"),
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<DiscountResponseDto>> getDiscountByCode(
                        @Parameter(description = "Discount code", example = "WELCOME10", required = true) @PathVariable String code) {
        ...
        @Operation(summary = "Get discounts by owner user ID", description = "Retrieves discounts created by a specific user (REFERRAL type discounts). Only ADMIN users can access this endpoint.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Discounts retrieved successfully"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Invalid or missing JWT token"),
                        @ApiResponse(responseCode = "403", description = "Forbidden - User does not have ADMIN role"),
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<PaginatedResponse<DiscountResponseDto>>> getDiscountsByOwnerUserId(
                        @Parameter(description = "Owner user ID", example = "user-001", required = true) @PathVariable String ownerUserId,
                ...
                log.info("Admin retrieving discounts by owner user ID: {} - page: {}, size: {}",
        ...
        @Operation(summary = "Update discount status", description = "Activates or deactivates a discount. Only ADMIN users can access this endpoint.")
        @ApiResponses(value = {
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<DiscountResponseDto>> updateDiscountStatus(
                        @Parameter(description = "Discount ID", example = "discount-uuid-123", required = true) @PathVariable String id,

                        @Parameter(description = "New status (true for active, false for inactive)", example = "true", required = true) @RequestParam boolean isActive) {
         ...
         */
        @DeleteMapping("/{id}")
        @Operation(summary = "Delete discount", description = "Deletes a discount permanently. Can only delete discounts that have never been used. Only ADMIN users can access this endpoint.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Discount deleted successfully"),
                        @ApiResponse(responseCode = "400", description = "Cannot delete discount that has been used"),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Invalid or missing JWT token"),
                        @ApiResponse(responseCode = "403", description = "Forbidden - User does not have ADMIN role"),
                        @ApiResponse(responseCode = "404", description = "Discount not found"),
                        @ApiResponse(responseCode = "500", description = "Internal server error")
         ...
         */
        @GetMapping("/validate")
        @Operation(summary = "Validate discount for use", description = "Validates if a discount can be used by a specific user for a course. Utility endpoint for testing and validation. Only ADMIN users can access this endpoint.")
        @ApiResponses(value = {
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<Boolean>> validateDiscount(
                        @Parameter(description = "Discount code", example = "WELCOME10", required = true) @RequestParam String discountCode,

                        @Parameter(description = "User ID", example = "user-001", required = true) @RequestParam String userId,

                        @Parameter(description = "Course ID", example = "course-001", required = true) @RequestParam String courseId) {

                log.info("Admin validating discount: {} for user: {} and course: {}",
                                discountCode, userId, courseId);
