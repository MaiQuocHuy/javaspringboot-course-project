...
/**
 * DiscountUsage entity to track when discounts are used
 * Records the actual usage of discount codes by users for specific courses
 */
@Entity
...
public class DiscountUsage {
    ...
    /**
     * The user who referred this purchase (only for REFERRAL type discounts)
     * This is the owner of the referral code used
     */
    @ManyToOne(fetch = FetchType.LAZY)
