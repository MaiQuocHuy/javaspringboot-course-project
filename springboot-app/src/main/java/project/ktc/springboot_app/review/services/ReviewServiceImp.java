...
public class ReviewServiceImp implements ReviewService {
  ...
  public ResponseEntity<ApiResponse<ReviewResponseDto>> createReview(
      String courseId, CreateReviewDto reviewDto) {
    ...
    log.info(
        "Successfully created review {} for course {} by user {}",
        savedReview.getId(),
        courseId,
        currentUserId);
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<ReviewResponseDto>>> getCourseReviews(
    ...
    List<ReviewResponseDto> reviewDtos =
        reviewsPage.getContent().stream().map(this::mapToResponseDto).collect(Collectors.toList());
  ...
  public ResponseEntity<ApiResponse<ReviewResponseDto>> updateReview(
      String reviewId, UpdateReviewDto reviewDto) {
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<StudentReviewResponseDto>>> getStudentReviews(
    ...
    try {
      ...
      // Convert to DTOs
      List<StudentReviewResponseDto> reviewDtos =
      ...
      PaginatedResponse<StudentReviewResponseDto> paginatedResponse =
          PaginatedResponse.<StudentReviewResponseDto>builder()
              .content(reviewDtos)
              .page(pageInfo)
              .build();

      log.info(
          "Successfully retrieved {} reviews for user {} (page {} of {})",
          reviewDtos.size(),
          currentUserId,
  ...
  @Override
  @Transactional(readOnly = true)
  public ResponseEntity<ApiResponse<PaginatedResponse<ReviewResponseDto>>> getCourseReviewsBySlug(
      String courseSlug, Pageable pageable) {
    ...
    try {
      ...
      PaginatedResponse<ReviewResponseDto> cachedResponse =
          reviewsCacheService.getCourseReviews(courseId, pageable);
  ...
  public ResponseEntity<ApiResponse<StudentReviewStatsDto>> getStudentReviewStats() {
    try {
      ...
      java.math.BigDecimal roundedAverage =
          java.math.BigDecimal.valueOf(averageRatingValue)
              .setScale(2, java.math.RoundingMode.HALF_UP);

      StudentReviewStatsDto stats =
          StudentReviewStatsDto.builder()
              .totalReviews(totalReviewsValue)
              .averageRating(roundedAverage.doubleValue())
              .build();

      log.info(
          "Review statistics retrieved successfully for user {}: Total={}, Average={}",
          currentUserId,
          totalReviewsValue,
          roundedAverage);
