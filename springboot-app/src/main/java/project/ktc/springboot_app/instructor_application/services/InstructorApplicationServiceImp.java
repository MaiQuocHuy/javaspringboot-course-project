...
public class InstructorApplicationServiceImp implements InstructorApplicationService {
	...
	public ResponseEntity<ApiResponse<DocumentUploadResponseDto>> uploadDocuments(
		...
		try {
			...
			String applicationId = applicationRepository
			...
			// Build response
			DocumentUploadResponseDto response = DocumentUploadResponseDto.builder().userId(currentUserId)
					.documents(documentUrls).build();
