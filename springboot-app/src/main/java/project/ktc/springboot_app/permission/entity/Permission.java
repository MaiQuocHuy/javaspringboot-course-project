...
/**
 * Permission Entity for Role-Based Access Control Represents a permission as a combination of
 * resource and action
 */
@Entity
@Table(
...
public class Permission extends BaseEntity {
  ...
  @JoinColumn(
      name = "action_id",
      nullable = false,
      foreignKey = @ForeignKey(name = "fk_permissions_action"))
  ...
  /** Convenience method to check if this permission matches the given resource and action */
