...
public class NotificationServiceImp implements NotificationService {
  ...
  public ResponseEntity<ApiResponse<PaginatedResponse<NotificationDto>>> getNotificationsByUserId(
    ...
    Page<NotificationDto> notificationDtoPage =
        notificationPage.map(notification -> mapToDto(notification, unreadCount));

    // Sử dụng static method of() để tạo PaginatedResponse
    PaginatedResponse<NotificationDto> paginatedResponse =
        PaginatedResponse.of(notificationDtoPage);

    // Sử dụng static method success() để tạo ApiResponse
    ApiResponse<PaginatedResponse<NotificationDto>> response =
        ApiResponse.success(paginatedResponse, "Notifications retrieved successfully");
