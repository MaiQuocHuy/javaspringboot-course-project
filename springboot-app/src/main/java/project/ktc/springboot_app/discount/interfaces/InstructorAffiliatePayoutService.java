...
public interface InstructorAffiliatePayoutService {
	...
	/**
	 * Get all affiliate payouts for courses owned by the instructor (Shows who gets
	 * commission on
	 ...
	 *
	 * @param search
	 *            Search term for affiliate payout ID, referrer name, course title,
	 *            or discount
	 *            code
	 * @param status
	 *            Filter by payout status
	 * @param fromDate
	 *            Filter by payout date from
	 * @param toDate
	 *            Filter by payout date to
	 * @param pageable
	 *            Pagination parameters
	 * @return ResponseEntity containing paginated list of affiliate payouts
	 */
