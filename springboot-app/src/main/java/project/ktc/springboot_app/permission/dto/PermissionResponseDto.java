...
public class PermissionResponseDto {
	...
	/**
	 * Whether the permission is active for this specific role (from
	 * role_permission.is_active) Only
	 * populated when retrieving permissions for a specific role
	 */
	private Boolean roleActive;

	/**
	 * Whether the permission is active at permission level (from
	 * permission.is_active) Only populated
