 ...
 * InstructorStatisticsCacheDto
 * Follows the established pattern of CategoryCacheMapper for clean separation
 * of concerns
 * between service DTOs and cache DTOs.
 */
public final class InstructorStatisticsCacheMapper {
     ...
     *
     * @param insDashboardDto the service DTO
     * @param instructorId    the instructor identifier
     * @return cache DTO optimized for Redis
     */
    public static InstructorStatisticsCacheDto toCacheDto(InsDashboardDto insDashboardDto, String instructorId) {
        ...
        return InstructorStatisticsCacheDto.builder()
                .courseTitle(
                        insDashboardDto.getCourseStatistics() != null ? insDashboardDto.getCourseStatistics().getTitle()
                                : null)
                .courseValue(
                        insDashboardDto.getCourseStatistics() != null ? insDashboardDto.getCourseStatistics().getValue()
                                : null)
                .courseDescription(insDashboardDto.getCourseStatistics() != null
                        ? insDashboardDto.getCourseStatistics().getDescription()
                        : null)
                .studentTitle(insDashboardDto.getStudentStatistics() != null
                        ? insDashboardDto.getStudentStatistics().getTitle()
                        : null)
                .studentValue(insDashboardDto.getStudentStatistics() != null
                        ? insDashboardDto.getStudentStatistics().getValue()
                        : null)
                .studentDescription(insDashboardDto.getStudentStatistics() != null
                        ? insDashboardDto.getStudentStatistics().getDescription()
                        : null)
                .revenueTitle(insDashboardDto.getRevenueStatistics() != null
                        ? insDashboardDto.getRevenueStatistics().getTitle()
                        : null)
                .revenueValue(insDashboardDto.getRevenueStatistics() != null
                        ? insDashboardDto.getRevenueStatistics().getValue()
                        : null)
                .revenueDescription(insDashboardDto.getRevenueStatistics() != null
                        ? insDashboardDto.getRevenueStatistics().getDescription()
                        : null)
                .ratingTitle(
                        insDashboardDto.getRatingStatistics() != null ? insDashboardDto.getRatingStatistics().getTitle()
                                : null)
                .ratingValue(
                        insDashboardDto.getRatingStatistics() != null ? insDashboardDto.getRatingStatistics().getValue()
                                : null)
                .ratingDescription(insDashboardDto.getRatingStatistics() != null
