...
public class SmtpEmailProvider implements EmailProvider {
  ...
  private void setupBasicProperties(MimeMessageHelper helper, EmailRequest emailRequest)
  ...
  private void setupEmailContent(MimeMessageHelper helper, EmailRequest emailRequest)
      throws MessagingException {
  ...
  private void addAttachments(MimeMessageHelper helper, EmailRequest emailRequest)
      throws MessagingException {
  ...
  private void addInlineImages(MimeMessageHelper helper, EmailRequest emailRequest)
      throws MessagingException {
