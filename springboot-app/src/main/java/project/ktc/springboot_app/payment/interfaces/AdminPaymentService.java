...
public interface AdminPaymentService {
	 ...
	 *
	 * @param search
	 *            Search term for payment ID, user name, or course title
	 * @param status
	 ...
	 * @param newStatus
	 *            The new status (COMPLETED or FAILED)
	...
	/**
	 * Paid out payment to instructor This action creates an instructor earning
	 * record and marks
	 * payment as paid out
	 *
	 * @param paymentId
	 *            The payment ID to paid out
