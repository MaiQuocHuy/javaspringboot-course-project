...
public interface CourseRepository
	...
	/**
	 * Lightweight query to get basic course info without sections/lessons for fast
	 * webhook processing
	 */
	...
	/**
	 * Get average rating for instructor's published and approved courses only This
	 * ensures
	 * consistency with course count query by only including courses that are
	...
	/**
	 * Get total published and approved course count by instructor Only counts
	 * courses that are
	...
	/**
	 * Check if a slug exists (case-insensitive) Used to prevent duplicate slugs
	 * with normalization
	 */
