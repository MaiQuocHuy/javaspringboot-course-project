...
/**
 * Helper service for creating system logs with simplified API Focuses on common CRUD operations
 * logging
 */
@Service
@Slf4j
...
public class SystemLogHelper {
  ...
  public void logUpdate(
      User user, String entityType, String entityId, Object oldValues, Object newValues) {
  ...
  private void createLog(
    ...
    try {
      ...
      log.debug(
          "System log created: {} action for {} entity with ID: {}", action, entityType, entityId);

    } catch (Exception e) {
      log.error(
          "Failed to create system log for {} action on {} entity: {}",
          action,
          entityType,
          e.getMessage());
    }
