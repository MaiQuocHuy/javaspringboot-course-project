 ...
 * when they request to reset their password. The tokens have expiration times
 * and attempt limits to ensure security.
 * 
 * Security features:
 * - OTP expires after a configurable time (default: 15 minutes)
 * - Limited number of verification attempts (default: 3)
...
public class PasswordResetToken extends BaseEntity {
    ...
    /**
     * The One-Time Password (OTP) code sent to the user.
     * Typically a 6-digit numeric code for security and usability.
     */
     ...
     * After this time, the OTP cannot be used for password reset.
     */
     ...
     * After this limit is reached, the token becomes invalid.
     */
     ...
     * A token is valid if it's not used, not expired, and hasn't reached max
     * attempts.
     * 
     ...
     * Used when an incorrect OTP is provided.
     */
     ...
     * Called after successful OTP verification and password reset.
     */
