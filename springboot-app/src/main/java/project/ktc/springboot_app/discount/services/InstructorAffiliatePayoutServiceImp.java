...
public class InstructorAffiliatePayoutServiceImp implements InstructorAffiliatePayoutService {
        ...
        public ResponseEntity<ApiResponse<PaginatedResponse<InstructorAffiliatePayoutResponseDto>>> getAffiliatePayouts(
                ...
                log.info("Getting affiliate payouts for instructor: {}, page: {}, size: {}",
                ...
                try {
                        ...
                        log.info("Successfully retrieved {} affiliate payouts for instructor: {}",
                                        responsePage.getTotalElements(), instructorId);

                        return ApiResponseUtil.success(paginatedResponse,
                                        "Instructor affiliate payouts retrieved successfully");
        ...
        public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<InstructorAffiliatePayoutResponseDto>> getAffiliatePayoutById(
                ...
                try {
                        AffiliatePayout affiliatePayout = instructorAffiliatePayoutRepository
                                        .findByIdAndCourseInstructorId(affiliatePayoutId, instructorId);

                        if (affiliatePayout == null) {
                                log.warn("Affiliate payout {} not found for instructor: {}", affiliatePayoutId,
                                                instructorId);
