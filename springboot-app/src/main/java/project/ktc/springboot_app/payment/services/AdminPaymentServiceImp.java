...
public class AdminPaymentServiceImp implements AdminPaymentService {
	...
	public ResponseEntity<ApiResponse<List<AdminPaymentResponseDto>>> getAllPayments() {
		try {
			...
			List<AdminPaymentResponseDto> paymentDtos = payments.stream().map(AdminPaymentResponseDto::fromEntity)
					.collect(Collectors.toList());
	...
	public ResponseEntity<ApiResponse<AdminPaymentStatisticsResponseDto>> getPaymentStatistics() {
		try {
			...
			AdminPaymentStatisticsResponseDto paymentStatistics = AdminPaymentStatisticsResponseDto.builder()
					.total(totalPayments)
	...
	/**
	 * Creates affiliate payout for referral discounts when payment is paid out This
	 * ensures
	...
	public void createAffiliatePayoutForReferralDiscount(Payment payment) {
		try {
			...
			List<DiscountUsage> discountUsages = discountUsageRepository.findByUserIdAndCourseId(
