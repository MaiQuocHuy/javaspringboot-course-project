...
/**
 * Notification service for automated payout processing Sends email
 * notifications about payout
...
public class PayoutNotificationService {
	 ...
	 *
	 * @param summary
	 *            The payout eligibility summary
	 */
	...
	private void tryWithTemplate(String adminEmail, String subject, String content) {
		try {
			...
			var result = emailService.sendTemplateEmail(
	...
	/**
	 * Send test notification to verify email configuration This method can be
	 * called manually to test
	 * email sending
	 */
