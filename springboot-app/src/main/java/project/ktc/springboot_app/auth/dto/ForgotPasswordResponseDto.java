 ...
 * 
 * This DTO is returned after successfully initiating a password reset request.
 * It provides information about the OTP that was sent without revealing the
 * actual code.
 * 
 * @author KTC Team
 * @version 1.0
...
public class ForgotPasswordResponseDto {
    ...
    /**
     * A message confirming that the OTP has been sent.
     * Generic message for security reasons.
     */
    private String message;

    /**
     * The email address to which the OTP was sent (masked for privacy).
     ...
     * Helps users understand the urgency of using the code.
     */
    private LocalDateTime expiresAt;

    /**
     * Maximum number of attempts allowed for this OTP.
     * Informs users about the attempt limit.
     */
    private Integer maxAttempts;

    /**
     * Indicates whether this is a new OTP or if previous tokens were invalidated.
     * Useful for informing users about security measures.
     */
     ...
     * Shows first few characters and domain while hiding middle part.
     * 
