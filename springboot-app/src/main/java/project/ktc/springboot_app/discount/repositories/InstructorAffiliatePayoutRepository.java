...
/**
 * Repository for instructor affiliate payout operations Handles queries for affiliate payouts from
...
public interface InstructorAffiliatePayoutRepository
  ...
  /** Find affiliate payouts for instructor's courses with search and filter options */
  @Query(
      """
                        SELECT ap FROM AffiliatePayout ap
                        JOIN FETCH ap.referredByUser u
