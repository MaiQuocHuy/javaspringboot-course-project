...
public class PaymentServiceImp implements PaymentService {
	...
	/**
	 * Helper method to get current user for logging purposes Returns a system user
	 * if no
	...
	public ResponseEntity<ApiResponse<List<PaymentResponseDto>>> getStudentPayments() {
		try {
			...
			// Convert to DTOs
			List<PaymentResponseDto> paymentDtos = payments.stream().map(PaymentResponseDto::fromEntity)
