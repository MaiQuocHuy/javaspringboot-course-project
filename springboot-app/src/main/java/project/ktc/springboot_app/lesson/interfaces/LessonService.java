...
public interface LessonService {
  ...
  /**
   * Retrieves a section with all its lessons, including completion status for the instructor
   *
   * @param sectionId The ID of the section
   * @return SectionWithLessonsDto containing section details and lessons with completion status
   */
  ...
  /**
   * Deletes a lesson from a section owned by the instructor If the lesson is of type VIDEO, the
  ...
  /**
   * Creates a new lesson with quiz in a single transaction Allows instructors to create a lesson
  ...
  /**
   * Retrieves paginated lesson submissions for a specific lesson owned by the instructor Includes
   * both students who have submitted and those who haven't, along with summary statistics
   *
  ...
  /**
   * Retrieves detailed information about a specific student submission for a lesson Only the
