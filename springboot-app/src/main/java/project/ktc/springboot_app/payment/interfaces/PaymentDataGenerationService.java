...
public interface PaymentDataGenerationService {
  ...
  /**
   * Generates sample payment data for testing and development purposes.
   * Creates payments for current year and two previous years with realistic
   * patterns
   * including seasonal variations, discount periods, and special occasions.
   * 
