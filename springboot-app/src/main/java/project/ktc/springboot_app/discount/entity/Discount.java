...
/**
 * Discount entity representing discount codes and their properties
 * Supports both GENERAL and REFERRAL discount types
 */
@Entity
...
public class Discount extends BaseEntity {
    ...
    /**
     * For GENERAL discounts: this should be null
     * For REFERRAL discounts: this is required and represents the user who created
     * the referral code
     */
    ...
    public boolean canUserUse(String userId) {
        ...
        long userUsageCount = discountUsages.stream()
