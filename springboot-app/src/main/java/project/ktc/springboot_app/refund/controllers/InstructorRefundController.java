...
public class InstructorRefundController {
    ...
    @Operation(summary = "Get all refunds", description = """
            Retrieves all refunds in the system with pagination support for instructor view.
    ...
    public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<PaginatedResponse<InstructorRefundResponseDto>>> getAllRefundsByInstructorId(
        ...
        log.info("Instructor retrieving all refunds with pagination: page={}, size={}", pageable.getPageNumber(),
                pageable.getPageSize());
        return instructorRefundService.getAllRefundsByInstructorId(pageable);
    }
    ...
    @Operation(summary = "Get all refunds (no pagination)", description = """
            Retrieves all refunds in the system without pagination for instructor view.
    ...
    public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<List<InstructorRefundResponseDto>>> getAllRefundsByInstructorId() {
        log.info("Instructor requesting all refunds without pagination");
    ...
    public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<AdminRefundStatusUpdateResponseDto>> updateRefundStatus(
        ...
        log.info("Instructor refund status update request for ID: {} with status: {}", id, updateDto.getStatus());
