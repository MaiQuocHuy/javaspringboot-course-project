...
public class ReviewsCacheService {
     ...
     * @param paginatedResponse the paginated review response to cache
     */
    public void storeCourseReviews(String courseId, Pageable pageable,
        ...
        try {
            ...
            log.debug("Successfully cached {} reviews for course: {}",
                    paginatedResponse.getContent().size(), courseId);
    ...
    public PaginatedResponse<ReviewResponseDto> getCourseReviews(String courseId, Pageable pageable) {
        try {
            ...
            if (cacheDto != null) {
                log.debug("Cache hit for course reviews - course: {}, page: {}", courseId, pageable.getPageNumber());
                return ReviewCacheMapper.fromCachePaginatedDto(cacheDto);
            }

            log.debug("Cache miss for course reviews - course: {}, page: {}", courseId, pageable.getPageNumber());
            return null;
