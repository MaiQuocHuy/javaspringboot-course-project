...
/**
 * Utility class for converting between user profile DTOs and cache DTOs.
...
public class UserProfileCacheMapper {
     ...
     * 
     * @param responseDto The UserResponseDto to convert
     ...
     * 
     * @param cacheDto The UserProfileCacheDto from cache
