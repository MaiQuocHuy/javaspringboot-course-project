...
@Tag(
    name = "Instructor's Enrolled Student Management",
    description = "Manage students enrolled in instructor's courses")
@RestController
...
public class InstructorStudentController {
  ...
  @Operation(
      summary = "Get instructor's enrolled students",
      description = "Retrieve a list of students enrolled in the instructor's courses",
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<
              PaginatedResponse<InstructorStudentDto>>>
      getEnrolledStudents(
          @Parameter(description = "Search term for student name or email")
  ...
  public ResponseEntity<
          project.ktc.springboot_app.common.dto.ApiResponse<InstructorStudentDetailsDto>>
  ...
  @GetMapping("/count")
  @Operation(
      summary = "Get number of enrolled students",
      description = "Retrieve the number of students enrolled in the instructor's courses",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Number of enrolled students retrieved successfully"),
        @ApiResponse(responseCode = "401", description = "Unauthorized - Invalid or missing token"),
        @ApiResponse(responseCode = "403", description = "Forbidden - Insufficient permissions"),
        @ApiResponse(responseCode = "500", description = "Internal server error")
      })
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<Long>>
