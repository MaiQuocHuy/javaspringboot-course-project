...
@Tag(
    ...
    description = "Endpoints for instructors to manage quiz content")
...
public class InstructorQuizControllerOld {
  ...
  @Operation(
      ...
      description =
          "Creates a new quiz with multiple choice questions for a lesson owned by the instructor. "
  ...
  @ApiResponses(
      value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - INSTRUCTOR role required or lesson not owned by instructor",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "409",
            description = "Conflict - Lesson already has quiz questions",
            content = @Content(mediaType = "application/json")),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
  ...
  public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<QuizResponseDto>>
      createQuiz(
          @Parameter(
                  description =
                      "Quiz creation data including title, description, lesson ID and questions")
              @Valid
              @RequestBody
