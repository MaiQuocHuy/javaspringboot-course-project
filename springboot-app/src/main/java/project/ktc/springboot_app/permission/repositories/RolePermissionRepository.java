...
public interface RolePermissionRepository extends JpaRepository<RolePermission, String> {
  ...
  boolean hasPermission(
      @Param("roleType") String roleType, @Param("permissionKey") String permissionKey);
  ...
  /**
   * Find all permissions assigned to a specific role (both active and inactive) Used for admin API
  ...
  @Query(
      "SELECT rp FROM RolePermission rp "
          ...
          + "WHERE rp.role = :role "
          + "AND p.permissionKey = :permissionKey")
  java.util.Optional<RolePermission> findByRoleAndPermissionKey(
      @Param("role") UserRole role, @Param("permissionKey") String permissionKey);
  ...
  @Query(
      "SELECT rp FROM RolePermission rp "
          ...
          + "AND rp.isActive = true "
          + "AND p.isActive = true ")
  List<RolePermission> findActiveByRoleAndPermission(
      @Param("roleId") String roleId, @Param("permissionKey") String permissionKey);
