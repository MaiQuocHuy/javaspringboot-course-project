...
/**
 * REST Controller for instructor discount operations Allows instructors to view
 * discount usage and
...
public class InstructorDiscountController {
	 ...
	 *
	 * @param search
	 *            Search by discount usage ID, discount code, user name, or course
	 *            title
	 * @param type
	 *            Filter by discount type
	 * @param fromDate
	 *            Filter by usage date from (ISO date string)
	 * @param toDate
	 *            Filter by usage date to (ISO date string)
	 * @param page
	 *            Page number (0-based)
	 * @param size
	 *            Page size
	 ...
	 *
	 * @param discountUsageId
	 *            The ID of the discount usage
	 ...
	 *
	 * @param affiliatePayoutId
	 *            The ID of the affiliate payout
