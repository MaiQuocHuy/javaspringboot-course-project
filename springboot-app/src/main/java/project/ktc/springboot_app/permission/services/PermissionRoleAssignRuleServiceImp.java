...
/**
 * Implementation of PermissionRoleAssignRuleService
 * Handles business logic for permission-role assignment constraints
 */
@Service
...
public class PermissionRoleAssignRuleServiceImp implements PermissionRoleAssignRuleService {
    ...
    @Override
    @Transactional
    public PermissionRoleAssignRule createAssignmentRule(String roleId, String permissionId, boolean isActive) {
        logger.info("Creating assignment rule: role={}, permission={}, active={}", roleId, permissionId, isActive);
    ...
    public PermissionRoleAssignRule updateAssignmentRule(String ruleId, boolean isActive) {
        ...
        // Find existing rule
        PermissionRoleAssignRule existingRule = assignRuleRepository.findById(ruleId)
                .orElseThrow(() -> new IllegalArgumentException("Assignment rule not found with ID: " + ruleId));
    ...
    public void validatePermissionAssignment(String roleId, String permissionId) {
        ...
        logger.debug("Permission assignment validation passed for role {} and permission {}", roleId, permissionId);
    }
}
