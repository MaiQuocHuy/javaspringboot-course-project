...
/**
 * DTO for internal use by repository queries to project student submission data with enrollment
 * information. Used to combine student info with their submission status.
 */
@Data
@Builder
@NoArgsConstructor
