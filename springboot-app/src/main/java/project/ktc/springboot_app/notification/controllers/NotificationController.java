...
public class NotificationController {
	...
	public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> createNotification(
		...
		try {
			NotificationResponseDto notification = notificationService.createNotification(createNotificationDto).get(); // Convert
			// async
			// to
			// sync
	...
	/**
	 * Create notification synchronously for internal system use This endpoint can
	 * be used by other
	...
	public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> createNotificationInternal(
		...
		try {
			NotificationResponseDto notification = notificationService.createNotificationSync(createNotificationDto);
	...
	public ResponseEntity<project.ktc.springboot_app.common.dto.ApiResponse<NotificationResponseDto>> createTestNotification() {
		...
		try {
			...
			NotificationResponseDto notification = notificationService.createNotificationSync(testNotification);
